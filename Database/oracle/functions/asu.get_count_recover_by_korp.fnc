DROP FUNCTION ASU.GET_COUNT_RECOVER_BY_KORP
/
...
--
CREATE OR REPLACE FUNCTION ASU."GET_COUNT_RECOVER_BY_KORP" (pFD_DATAC IN DATE,pFK_KORPID IN NUMBER) -- Created by TimurLan
  RETURN NUMBER
  IS
