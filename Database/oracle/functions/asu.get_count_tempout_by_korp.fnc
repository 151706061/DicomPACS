DROP FUNCTION ASU.GET_COUNT_TEMPOUT_BY_KORP
/

--
-- GET_COUNT_TEMPOUT_BY_KORP  (Function) 
--
--  Dependencies: 
--   STANDARD (Package)
...
--
CREATE OR REPLACE FUNCTION ASU."GET_COUNT_TEMPOUT_BY_KORP" (pFD_DATAC IN DATE,pFK_KORPID IN NUMBER) -- Created by TimurLan
  RETURN NUMBER
  IS
