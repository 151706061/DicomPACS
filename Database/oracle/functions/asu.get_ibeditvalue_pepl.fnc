DROP FUNCTION ASU.GET_IBEDITVALUE_PEPL
/

--
-- GET_IBEDITVALUE_PEPL  (Function) 
--
--  Dependencies: 
--   STANDARD (Package)
...
--
CREATE OR REPLACE FUNCTION ASU."GET_IBEDITVALUE_PEPL" (pacid IN NUMBER, smeditid IN NUMBER)
  RETURN VARCHAR2 --by TimurLan
IS
  CURSOR c1
  IS
    SELECT /*+ rule*/
