DROP FUNCTION ASU.GET_KDN_PRIZN_SUBVID_SHORT
/
...
--   TKARTA (Table)
--
CREATE OR REPLACE FUNCTION ASU."GET_KDN_PRIZN_SUBVID_SHORT" (pFD_DATAC IN DATE,pFK_PRIZN IN NUMBER,pFK_KOD2 IN NUMBER,pFK_KOD IN NUMBER)
