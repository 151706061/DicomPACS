DROP FUNCTION ASU.GET_KDN_PRIZN_VID
/

--
-- GET_KDN_PRIZN_VID  (Function) 
--
--  Dependencies: 
--   STANDARD (Package)
...
--   TKARTA (Table)
--
CREATE OR REPLACE FUNCTION ASU."GET_KDN_PRIZN_VID" (pFD_DATAC IN DATE,pFK_PRIZN IN NUMBER,pFK_KOD2 IN NUMBER)
