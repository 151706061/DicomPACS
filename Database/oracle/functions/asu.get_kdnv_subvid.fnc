DROP FUNCTION ASU.GET_KDNV_SUBVID
/
...
--   TKARTA (Table)
--
CREATE OR REPLACE FUNCTION ASU."GET_KDNV_SUBVID" 
(pFD_DATAC IN DATE,pFK_PRIZN IN NUMBER,pFK_KOD IN NUMBER)
  ...
  Cursor c IS select/*+ first_row */count(*) as fn_count
                    ...
                    where
                                  ...
                                  and fk_pryb<>3
                                  and fk_pryb<>7
                    AND TKARTA.FK_ID=FK_PACID AND TKARTA.FP_TEK_COC=3  and tkarta.FK_KOD2=pfk_prizn AND FK_KOD=pFK_KOD
                    union
