DROP FUNCTION ASU.GET_PAC_AD_L
/

--
-- GET_PAC_AD_L  (Function) 
--
--  Dependencies: 
--   STANDARD (Package)
...
--   TTEMPLIST (Table)
--
CREATE OR REPLACE FUNCTION ASU."GET_PAC_AD_L" (pFK_PACID  IN BINARY_INTEGER,
...
BEGIN
  ...
  FOR p IN (SELECT FN_VALUE, FD_ZAPOLN, FC_TIME
             ...
             WHERE FK_PACID = pFK_PACID
               ...
               AND (FC_SYNONIM = 'TL_AD_L_UTRO' OR FC_SYNONIM = 'TL_AD_L_VECHER')
