DROP FUNCTION ASU.GET_RESULT_MTABLE2
/
...
--
CREATE OR REPLACE FUNCTION ASU."GET_RESULT_MTABLE2" (pFK_NAZID IN NUMBER)
  RETURN NUMBER IS
--
...
BEGIN
  ...
  str    :=
    '<table style="font-size: 10pt" width="100%" border="1" align="center" bordercolordark="#FFFFFF" bordercolorlight="#000000" cellpadding="0" cellspacing="0"><TR ALIGN="CENTER"><TD>Наименование:</TD><TD >Ед.изм.:</TD><TD >Норма:</TD>';
