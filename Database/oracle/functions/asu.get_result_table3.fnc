DROP FUNCTION ASU.GET_RESULT_TABLE3
/

--
-- GET_RESULT_TABLE3  (Function) 
--
--  Dependencies: 
--   STANDARD (Package)
--   DBMS_LOB (Synonym)
...
--
CREATE OR REPLACE FUNCTION ASU."GET_RESULT_TABLE3" (pFK_NAZID IN NUMBER)
  RETURN NUMBER IS
--
...
-- Wrote by Philip A. Milovanov
  CURSOR cD (pFK_SMID NUMBER) IS
    SELECT/*+rule*/ TO_CHAR (FD_INS, 'dd.mm.yyyy'), get_fullpath_sha(TSMID.FK_ID) FC_NAME
      FROM TRESAN, TSMID
