DROP FUNCTION ASU.ISMEDNAZ_CONTAIN_SPECIALMEDIC
/

--
-- ISMEDNAZ_CONTAIN_SPECIALMEDIC  (Function) 
--
--  Dependencies: 
--   STANDARD (Package)
...
--
CREATE OR REPLACE FUNCTION ASU."ISMEDNAZ_CONTAIN_SPECIALMEDIC" (pnazid IN NUMBER) RETURN NUMBER IS
