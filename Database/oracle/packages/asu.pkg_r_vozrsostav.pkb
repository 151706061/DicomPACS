DROP PACKAGE BODY ASU.PKG_R_VOZRSOSTAV
/

--
-- PKG_R_VOZRSOSTAV  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY ASU."PKG_R_VOZRSOSTAV" 
 IS-- Created by TimurLan
  ...
  BEGIN
    ...
    str := PKG_HTML.GET_HEAD('excel','Возрастной состав отдыхающих в санатории "'||PKG_SMINI.READSTRING('CONFIG','S_NAME','Не известен')||'" за период с '||TO_CHAR(pFD_DATA1,'dd.mm.yyyy')||' по '||TO_CHAR(pFD_DATA2,'dd.mm.yyyy'),
                             null,null,null,
                             null,null,null,
                             null,null,null,
                             null,null,'landscape',
    ...
    str:='<BODY>'||
         '<P ALIGN="CENTER"><B>Возрастной состав отдыхающих в санатории "'||PKG_SMINI.READSTRING('CONFIG','S_NAME','Не известен')||'"</B><BR>'||
