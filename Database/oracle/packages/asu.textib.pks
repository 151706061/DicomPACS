...
--   STANDARD (Package)
--
CREATE OR REPLACE PACKAGE ASU."TEXTIB" 
 IS
  ...
  FUNCTION getFullIbClobID_by_SET(pFC_PACID IN VARCHAR2,pFN_MODE IN NUMBER DEFAULT 0,pFN_TYPE IN NUMBER DEFAULT 1,pFN_CALLTYPE IN NUMBER DEFAULT 0) RETURN NUMBER; -- by TimurLan Сбор полной ИБ
