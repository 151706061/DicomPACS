DROP PROCEDURE ASU.SET_MICROB_IDENT
/

--
-- SET_MICROB_IDENT  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
...
--
CREATE OR REPLACE PROCEDURE ASU."SET_MICROB_IDENT" (pname  asu.tsmid.fc_name%type,
                                                pident varchar2) is
  bak_lab_id      number := 982257;
