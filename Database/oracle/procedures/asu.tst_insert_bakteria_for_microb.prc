DROP PROCEDURE ASU.TST_INSERT_BAKTERIA_FOR_MICROB
/

--
-- TST_INSERT_BAKTERIA_FOR_MICROB  (Procedure) 
--
--  Dependencies: 
--   STANDARD (Package)
...
--
CREATE OR REPLACE PROCEDURE ASU."TST_INSERT_BAKTERIA_FOR_MICROB" (pname varchar2,pOwner Number, pNazSmidID number) is
 -- bak_lab_id      number := 789193;
  v_smid_name     asu.tsmid.fc_name%type;
  v_analizator_id number := 941;
