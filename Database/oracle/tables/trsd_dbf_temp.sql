...
COMMENT ON TABLE ASU.TRSD_DBF_TEMP IS 'Загруженные из RSD ошибки выгрузки (создана для решения задачи загрузки ошибок полученных из страховой компании) Author:Efimov'
/
