object frmSet: TfrmSet
  ...
  object al: TActionList
    ...
    object aClear: TAction
      Hint = #1054#1095#1080#1089#1090#1080#1090#1100' '#1090#1077#1082#1089#1090' '#1092#1080#1083#1100#1090#1088#1072
  ...
  object odsList: TOracleDataSet
    SQL.Strings = (
      ...
      '  from asu.tsmid'
        ...
        ' where --fk_owner = (select fk_id from asu.tsmid where fc_synoni' +
        'm = :pfc_synonim)'
      '       fl_del = 0'
      '   and level <> 1'
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      4D45010000000000090000004C4F5745524E414D45010000000000}
    Cursor = crSQLWait
    Session = frmMain.os
    Left = 232
    Top = 176
  ...
  object odsTravm: TOracleDataSet
    SQL.Strings = (
      'select -1 fk_id, '#39#39' fc_name '
      '  from dual '
      ''
      'union all'
      ''
      ...
      '  from (select fk_id,'
        ...
        '               ltrim(decode(level, 1,'#39#39',2,'#39#39',prior fc_name || '#39' ' +
        #39') || '#39' '#39' ||fc_name) fc_name'
      '          from asu.tsmid'
