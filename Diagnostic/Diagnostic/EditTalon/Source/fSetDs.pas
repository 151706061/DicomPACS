...
uses
  ...
  cxLabel, cxCalendar, cxTextEdit, dxSkinOffice2007Green, ExtCtrls;
...
begin
  if VarToStr(rowVyavlen.Properties.Value) = '' then
    begin
      Application.MessageBox('ѕрежде чем выбрать диагноз укажите признак вы€влени€ диагноза!',
                             '¬нимание', mb_iconwarning+mb_ok);
      rowVyavlen.Focused := True;
      exit;                       
    end;
  ModalResult := mrOk;
end;
