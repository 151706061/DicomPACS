...
uses
  ...
  fSet in '..\Source\fSet.pas' {frmSet},
  fSetDoc in '..\Source\fSetDoc.pas' {frmSetDoc},
  fCommit in '..\Source\fCommit.pas' {frmCommit},
  fSetDs in '..\Source\fSetDs.pas' {frmSetDs},
  fEditDs in '..\Source\fEditDs.pas' {frmEditDs},
  fSetOpl in '..\Source\fSetOpl.pas' {frmSetOpl},
  fSetSotr in '..\Source\fSetSotr.pas' {frmSetSotr},
  fSetUch in '..\Source\fSetUch.pas' {frmSetUch};

{$R *.res}

procedure InitPlugin(nPacid : Integer; nNazid : Integer; nSotrid : Integer); stdcall;
begin
  Application.CreateForm(TfrmMain, frmMain);
  frmMain.DoShowfrmMain(nPacid, nNazid, nSotrid);
  frmMain.ShowModal;
end;

function InitPluginRes(nPacid : Integer; nNazid : Integer; nSotrid : Integer):integer; stdcall;
begin
  Application.CreateForm(TfrmMain, frmMain);
  frmMain.DoShowfrmMain(nPacid, nNazid, nSotrid);
  frmMain.ShowModal;
