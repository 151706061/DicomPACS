object frmMetodics: TfrmMetodics
  ...
  object odsMetodics: TOracleDataSet
    SQL.Strings = (
      ...
      '  FROM asu.TS_COLUMNNAZ'
        ...
        ' WHERE FK_OWNER in (SELECT FK_ID FROM asu.TS_COLUMNNAZ WHERE FC_' +
        'SYNONIM = :PFC_SYNONIM and fk_owner = asu.get_form30id)'
      '   AND FL_DEl = 0'
      'ORDER BY FC_NAME')
    Optimize = False
    Variables.Data = {
  ...
  object frxRepMetodics: TfrxReport
    ...
    ReportOptions.LastChange = 41313.584438101850000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo3: TfrxMemoView
          ...
          Frame.Width = 2.000000000000000000
          Memo.UTF8 = (
            #1056#1038#1056#1111#1056#1105#1057#1027#1056#1109#1056#1108' '#1056#1112#1056#181#1057#8218#1056#1109#1056#1169#1056#1105#1056#1108'. '#1056#1031#1057#8225#1056#181#1056#8470#1056#1108#1056#176' [CELL]')
          ParentFont = False
        end
