...
uses
  ...
  cxCalendar, dxSkinsCore, dxSkinsDefaultPainters, cxRadioGroup, cxLabel, cxCheckBox,
  dxSkinsdxBarPainter, dxBar, dxBarExtItems, cxClasses, cxLookAndFeelPainters, cxGroupBox;
...
type
  TfrmPeriod = class(TForm)
    ...
    acOk: TAction;
    acCancel: TAction;
    rbFullYear: TcxRadioButton;
    gbMounth: TcxGroupBox;
    rbSeptember: TcxRadioButton;
    rbAugust: TcxRadioButton;
    rbJune: TcxRadioButton;
    rbJule: TcxRadioButton;
    rbMay: TcxRadioButton;
    rbApril: TcxRadioButton;
    rbMarch: TcxRadioButton;
    rbFebruary: TcxRadioButton;
    rbDecember: TcxRadioButton;
    rbNovember: TcxRadioButton;
    rbOctober: TcxRadioButton;
    rbJanuary: TcxRadioButton;
    gbQuartal: TcxGroupBox;
    rbFirstQuartal: TcxRadioButton;
    rbSecondQuartal: TcxRadioButton;
    rbThirdQuartal: TcxRadioButton;
    rbFourthQuartal: TcxRadioButton;
    gbYearPart: TcxGroupBox;
    rbFirstPartYear: TcxRadioButton;
    rbSecondPartYear: TcxRadioButton;
    gbYear: TGroupBox;
    LabelS: TcxLabel;
    LabelPo: TcxLabel;
    cbBeg: TcxCheckBox;
