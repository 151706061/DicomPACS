...
var oq : TOracleQuery;                                                       // в TAMBTALON (если услуга консультативная? и если talonid <> 0)
begin
...
var oq : TOracleQuery;
begin
  if Application.MessageBox('Выбранной консультации поставится статус "Отменено" и причина отмены "Неявка пациента". Продолжить?',
                            'Внимание !',
...
//        begin
//          ShowPacInfo(Application.Handle, -1, True, pSOTRID); // -1 - ???; 2й параметр код пациента, 3й - разрешение редактирования, 4й - код сотрудника
//        end;
//        FreeLibrary(hHandle);
//    end;
end;
