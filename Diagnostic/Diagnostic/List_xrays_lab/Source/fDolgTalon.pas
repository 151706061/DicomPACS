    ...
    then begin
      ...
      try
        InitPlugin_A(Application.Handle,
                     tvDolg.DataController.Values[tvDolg.DataController.FocusedRecordIndex, tvDolg_PacId.Index],
                     frmMain.pSOTRID,
                      -1,
                     tvDolg.DataController.Values[tvDolg.DataController.FocusedRecordIndex, tvDolg_TalonId.Index]);
      except
        on E:  Exception
        do begin
