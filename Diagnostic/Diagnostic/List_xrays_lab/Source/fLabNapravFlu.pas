...
procedure TfrmLabNapravFlu.aAgreeMRT1Execute(Sender: TObject);
begin
...
procedure TfrmLabNapravFlu.aAgreeSurgery1Execute(Sender: TObject);
begin
...
procedure TfrmLabNapravFlu.aAgreeTomoContrast1Execute(Sender: TObject);
begin
  ...
  if f_gtTSMINI('DLL_WORKLIST_NAZN','MYWORKLIST_USE')='1' then
    ...
    begin
      if cxMale.Checked then
        ...
        v_fpol:='F';
      SenfDataToWorklist ( cxNumIssl.Text, // p_AccessionNumber,
                           v_fpol,          // Пол
