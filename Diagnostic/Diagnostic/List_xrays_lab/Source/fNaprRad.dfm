object frmNaprRad: TfrmNaprRad
  ...
  object odsVidIssled: TOracleDataSet
    SQL.Strings = (
      
        'select 0 as fk_id,'#39#39' as fc_name, 0 as fk_owner, '#39#39' as fc_synonim' +
        ' from dual'
      'union all'
      'SELECT FK_ID, FC_NAME, FK_OWNER, FC_SYNONIM'
      '  FROM ASU.TSMID'
      ' WHERE LEVEL > 1'
      'CONNECT BY PRIOR FK_ID = FK_OWNER'
      ' START WITH FC_SYNONIM = '#39'RADIO_TYPE'#39)
    Optimize = False
    Session = frmMain.os
    Left = 928
    Top = 528
  end
  object dsVidIssled: TDataSource
    DataSet = odsVidIssled
    Left = 960
    Top = 528
  end
end
