...
uses
  ...
  dxSkinBlack, IniFiles, cxCalendar, JvStringHolder, Medotrade;
          ...
          Try
            ...
            begin
              ...
              begin
                ...
                v_an  := odsNaz.FieldByName('FC_TYPE').AsString;  //   FC_accessionnumber
    ...
    begin // SOKB
      ...
      begin
        vRunStr := 'asDicomViewer 1 '+               // check_viewer v_isPostgres
          ...
          odsNaz.FieldByName('FC_TYPE').AsString;               // accessionnumber
          try
...
{$IFDEF USE_NEW_AUTH}
  ...
  try
    ...
    // ShowMessage('RUN EXE : '+ExtractFilePath(paramstr(0))+'IBRazdel.exe '+ IntToStr(odsPac.FieldByName('PACID').AsInteger)+' '+IntToStr(-1)+' '+IntToStr(-1));
    Application.ProcessMessages;
    Sleep(100);
