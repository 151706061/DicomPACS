    ...
    MultipleStrings = <
      item
        ...
        Strings.Strings = (
          ...
          '       TAMBULANCE.FC_FAM || '#39' '#39' || TAMBULANCE.FC_IM || '#39' '#39' ||'
          '       TAMBULANCE.FC_OTCH FIO,'
          
            '       DECODE(TO_CHAR(TAMBULANCE.FD_ROJD, '#39'dd.mm.yyyy hh24:mi:ss' +
            #39'),'
          '              '#39'00.00.0000 00:00:00'#39','
          '              TRUNC(SYSDATE),'
          '              TAMBULANCE.FD_ROJD) FD_ROJD,'
          
            '       ASU.PKG_REGIST_PEPLFUNC.GET_PEPL_AGE_NOW(TAMBULANCE.FK_PE' +
            'PLID) AS AGE,'
          '       TUSLVID.FC_NAME,'
          '       DECODE(TAMBULANCE.FP_SEX,'
          '              0,'
          '              '#39#1046#1077#1085#1089#1082#1080#1081#39','
          '              1,'
          '              '#39#1052#1091#1078#1089#1082#1086#1081#39','
          '              -1,'
          ...
          '       (SELECT MAX(1)'
          '          FROM ASU.TNAZIS'
          '         WHERE TNAZIS.FK_PACID = TAMBULANCE.FK_PEPLID'
          '           AND FK_SMID = ASU.GET_XRAY_TUBDISPANCER'
          '           AND SYSDATE >= FD_NAZ'
          ...
          '       (SELECT MAX(1)'
          '          FROM ASU.TNAZIS'
          '         WHERE FK_PACID = TAMBULANCE.FK_PEPLID'
          
            '           AND FK_SMID = ASU.GET_XRAY_TUBDISPANCER) AS CNTTUB_AL' +
            'L,'
          '       /*ASU.GET_PLAN_FLUORO_DATE(TAMBULANCE.FK_PEPLID)*/'
          
            '       ADD_MONTHS(TO_DATE(ASU.GET_LAST_FLUORO(TAMBULANCE.FK_PEPL' +
            'ID, 2),'
          '                          '#39'dd.mm.yyyy'#39'),'
          '                  DECODE((SELECT ASU.GET_SYNBYID(FK_SMID)'
          '                           FROM ASU.TIB'
          '                          WHERE FK_PACID = TAMBULANCE.FK_PEPLID'
          '                            AND FK_SMID IN'
          '                                (SELECT FK_ID'
          ...
          '                                  START WITH FC_SYNONIM ='
            ...
            '                                             '#39'XRAY_PERIOD_OSMOTR' +
            'OV'#39
          
            '                                 CONNECT BY PRIOR FK_ID = FK_OWN' +
            'ER)),'
          '                         '#39'ONE_IN_YEAR'#39','
          '                         12,'
          '                         '#39'ONE_IN_2YEARS'#39','
          ...
          'SELECT TKARTA.FK_PEPLID AS FK_ID,'
            ...
            '       TKARTA.FC_FAM || '#39' '#39' || TKARTA.FC_IM || '#39' '#39' || TKARTA.FC_' +
            'OTCH FIO,'
          '       DECODE(TO_CHAR(TKARTA.FD_ROJD, '#39'dd.mm.yyyy hh24:mi:ss'#39'),'
          '              '#39'00.00.0000 00:00:00'#39','
          '              TRUNC(SYSDATE),'
          '              TKARTA.FD_ROJD) FD_ROJD,'
          ...
          '              3,'
          '              '#39#1042#1099#1087#1080#1089#1072#1085#39','
          '              2,'
          '              '#39#1042' '#1089#1090#1072#1094#1080#1086#1085#1072#1088#1077#39','
          '              -2,'
          '              '#39#1053#1072' '#1086#1092#1086#1088#1084#1083#1077#1085#1080#1080' '#1055#1054#39','
          '              '#39#39') AS STEK_COC,'
          '       TKARTA.FK_ID PACID,'
          '       ASU.GET_LAST_FLUORO(TKARTA.FK_PEPLID) AS LASTFLU,'
          '       0 AS IS_AMBULANCE,'
          ...
          '         WHERE FK_PACID = TKARTA.FK_PEPLID'
            ...
            '           AND FK_SMID = ASU.GET_XRAY_TUBDISPANCER) AS CNTTUB_AL' +
            'L,'
          '       /*asu.get_plan_fluoro_date(tkarta.fk_peplid)*/'
          
            '       ADD_MONTHS(TO_DATE(ASU.GET_LAST_FLUORO(TKARTA.FK_PEPLID, ' +
            '2),'
          '                          '#39'dd.mm.yyyy'#39'),'
          '                  DECODE((SELECT ASU.GET_SYNBYID(FK_SMID)'
          '                           FROM ASU.TIB'
