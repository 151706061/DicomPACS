...
begin
  tvDrv.StoreToRegistry('\SoftWare\TaxiService\Admin\fSetNumDrv', True, [], 'tvDrv');
end;

procedure TfrmSetNumDrv.FormCreate(Sender: TObject);
begin
  tvDrv.StoreToRegistry('\SoftWare\TaxiService\Admin\fSetNumDrvDefault', True, [], 'tvDrv');
  tvDrv.RestoreFromRegistry('\SoftWare\TaxiService\Admin\fSetNumDrv', False, False, [], 'tvDrv');
end;
...
begin
  tvDrv.RestoreFromRegistry('\SoftWare\TaxiService\Admin\fSetNumDrvDefault', False, False, [], 'tvDrv');
end;
