object frmNumAbonent: TfrmNumAbonent
  Left = 269
  Top = 115
  BorderStyle = bsNone
  BorderWidth = 1
  ...
  object paTop: TPanel
    ...
    object teNum: TcxTextEdit
      ...
      Properties.OnChange = teNumPropertiesChange
      ...
      OnKeyPress = teNumKeyPress
      Width = 189
    end
    object lbKod: TcxLabel
      Left = 156
      Top = 42
      Caption = '-'
      ParentFont = False
