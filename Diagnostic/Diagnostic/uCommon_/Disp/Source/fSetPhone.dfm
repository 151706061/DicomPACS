object frmSetPhone: TfrmSetPhone
  Left = 578
  Top = 308
  BorderStyle = bsNone
  ...
  object Panel1: TPanel
    ...
    object meVvod: TcxMaskEdit
      ...
      Properties.OnChange = meVvodPropertiesChange
  ...
  object al: TActionList
    ...
    object aOk: TAction
      Caption = #1054#1050
      Hint = #1057#1086#1093#1088#1072#1085#1080#1090#1100' '#1085#1086#1084#1077#1088' '#1090#1077#1083#1077#1092#1086#1085#1072
      ShortCut = 113
