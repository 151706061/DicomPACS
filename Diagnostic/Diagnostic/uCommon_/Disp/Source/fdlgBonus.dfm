object dlgBonus: TdlgBonus
  ...
  object Panel1: TPanel
    ...
    object lbCap: TcxLabel
      Left = 10
      Top = 6
      Caption = #1061#1086#1090#1080#1090#1077' '#1074#1079#1103#1090#1100' '#1073#1086#1085#1091#1089#1085#1091#1102' '#1087#1086#1077#1079#1076#1082#1091'?'
      ParentFont = False
  ...
  object al: TActionList
    ...
    object aOk: TAction
      Caption = #1044#1072
      Hint = #1042#1079#1103#1090#1100' '#1073#1086#1085#1091#1089#1085#1091#1102' '#1087#1086#1077#1079#1076#1082#1091
      ShortCut = 113
      OnExecute = aOkExecute
    end
    object aCancel: TAction
      Caption = #1053#1077#1090
      Hint = #1053#1077' '#1073#1088#1072#1090#1100' '#1073#1086#1085#1091#1089#1085#1091#1102' '#1087#1086#1077#1079#1076#1082#1091
      ShortCut = 27
