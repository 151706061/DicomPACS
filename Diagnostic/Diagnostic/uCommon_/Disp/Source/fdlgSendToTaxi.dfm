object dlgSendToTaxi: TdlgSendToTaxi
  Left = 257
  Top = 104
  BorderStyle = bsNone
  Caption = #1055#1077#1088#1077#1076#1072#1090#1100' '#1079#1072#1082#1072#1079
  ClientHeight = 108
  ClientWidth = 312
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object lbCap: TcxLabel
      Left = 9
      Top = 3
      Caption = #1055#1077#1088#1077#1076#1072#1090#1100' '#1079#1072#1082#1072#1079' '#1074
      ParentFont = False
  ...
  object al: TActionList
    ...
    object aYes: TAction
      Caption = #1044#1072
      Hint = #1055#1086#1076#1090#1074#1077#1088#1076#1080#1090#1100' '#1087#1077#1088#1077#1076#1072#1095#1091' '#1079#1072#1082#1072#1079#1072
      ShortCut = 113
      OnExecute = aYesExecute
    end
  end
end
