...
uses fPacInfo, fOtmena, fEditNaz, fSearch, fRegistrAmbPac, fRegistrAmbPacFlu,
...
begin
  ...
  try
    ...
    ods.SQL.Text := ' SELECT asu.get_nazcancel, asu.get_vipnaz, asu.get_labvip, asu.get_registrator_fluoro, asu.get_nevip, '+#13+
                    ...
                    '        (select fk_id from asu.tsmid where fc_synonim = ''TARGET_PROFILAKTIKA'') as get_id_profilaktika,asu.GET_XRAYS_OTDEL,asu.rgreg_hide_last_fluoro '+#13+
                    '   FROM DUAL ';
    ods.Close;
    try
      ods.Open;
      ...
      GET_DB_NAME := ods.FieldByName('GET_PASS_REGISTRATOR').AsString;
