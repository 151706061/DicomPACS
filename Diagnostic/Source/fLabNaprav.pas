...
type
  ...
  TfrmLabNaprav = class(TForm)
    ...
    procedure cxNumIssl1PropertiesValidate(Sender: TObject;
...
var v_is_ok : Boolean; v_err:Integer; v_an:string;
begin
...
procedure TfrmLabNaprav.cxNumIssl1PropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
var oq : TOracleQuery;
  ...
  begin
   ...
   // Showmessage(vAccessionNumberOLD);

    Application.ProcessMessages;
  end;
begin
  if trim(cxNumIssl1.Text)='' then Exit;
