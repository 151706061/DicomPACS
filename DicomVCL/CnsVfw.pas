 ...
 ***************************************************************************)
                                {
function InitVFW: longint; stdcall;
function TermVFW: longint; stdcall;  }
...
function mmioFOURCCEx(ch0, ch1, ch2, ch3: Char): FOURCC;
...
type
  TICCompressProc = function(lInputOutput: LPARAM; lFrame: DWORD; lpBits: pointer; len: longint): longint; stdcall;
...
type
  ...
  TICStatusProc = function(lParam: LPARAM; message: UINT; l: longint): longint; stdcall;
...
function DrawDibUpdate(hdd: HDRAWDIB; hdc: HDC; x, y: integer): BOOL;
...
const
  formtypeAVI = $20495641; // mmioFOURCCExEx('A', 'V', 'I', ' ')
  listtypeAVIHEADER = $6C726468; // mmioFOURCCEx('h', 'd', 'r', 'l')
  ckidAVIMAINHDR = $68697661; // mmioFOURCCEx('a', 'v', 'i', 'h')
  listtypeSTREAMHEADER = $6C727473; // mmioFOURCCEx('s', 't', 'r', 'l')
  ckidSTREAMHEADER = $68727473; // mmioFOURCCEx('s', 't', 'r', 'h')
  ckidSTREAMFORMAT = $66727473; // mmioFOURCCEx('s', 't', 'r', 'f')
  ckidSTREAMHANDLERDATA = $64727473; // mmioFOURCCEx('s', 't', 'r', 'd')
  ckidSTREAMNAME = $6E727473; // mmioFOURCCEx('s', 't', 'r', 'n')

  listtypeAVIMOVIE = $69766F6D; // mmioFOURCCEx('m', 'o', 'v', 'i')
  listtypeAVIRECORD = $20636572; // mmioFOURCCEx('r', 'e', 'c', ' ')

  ckidAVINEWINDEX = $31786469; // mmioFOURCCEx('i', 'd', 'x', '1')

  {-- Stream types for the <fccType> field of the stream header ----------------}

  streamtypeVIDEO = $73646976; // mmioFOURCCEx('v', 'i', 'd', 's')
  streamtypeAUDIO = $73647561; // mmioFOURCCEx('a', 'u', 'd', 's')
  streamtypeMIDI = $7364696D; // mmioFOURCCEx('m', 'i', 'd', 's')
  streamtypeTEXT = $73747874; // mmioFOURCCEx('t', 'x', 't', 's')
  ...
  ckidAVIPADDING = $4B4E554A; // mmioFOURCCEx('J', 'U', 'N', 'K')
...
type
  TAVISAVECALLBACK = function(i: integer): BOOL; pascal;
...
type
  ...
  IAVIStream = interface(IUnknown)
    ...
    function FindSample(lPos: longint; lFlags: longint): longint; stdcall;
    function ReadFormat(lPos: longint; lpFormat: pointer; var lpcbFormat: longint): HResult; stdcall;
    function SetFormat(lPos: longint; lpFormat: pointer; cbFormat: longint): HResult; stdcall;
    function Read(lStart: longint; lSamples: longint; lpBuffer: pointer; cbBuffer: longint; var plBytes, plSamples: longint): HResult; stdcall;
    function Write(lStart: longint; lSamples: longint; lpBuffer: pointer; cbBuffer: longint; dwFlags: DWORD; var plSampWritten, plBytesWritten: longint): HResult; stdcall;
    function Delete(lStart: longint; lSamples: longint): HResult; stdcall;
  ...
  IAVIStreaming = interface(IUnknown)
    function _Begin(lStart, lEnd: longint; lRate: longint): HResult; stdcall;
    function _End: HResult; stdcall;
  end;

  IAVIEditStream = interface(IUnknown)
    function Cut(var plStart, plLength: longint; var ppResult: IAVIStream): HResult; stdcall;
    function Copy(var plStart, plLength: longint; var ppResult: IAVIStream): HResult; stdcall;
    function Paste(var plPos: longint; var plLength: longint; pstream: IAVIStream; lStart, lEnd: longint): HResult; stdcall;
  ...
  IAVIFile = interface(IUnknown)
    function Info(var pfi: TAVIFileInfoW; iSize: longint): HResult; stdcall;
    ...
    function ReadData(ckid: DWORD; lpData: pointer; lpcbData: PLONGINT): HResult; stdcall;
...
function AVIFileInfoW(pfile: IAVIFile; var pfi: TAVIFILEINFOW; lSize: longint): HResult; stdcall;
function AVIFileInfoA(pfile: IAVIFile; var pfi: TAVIFILEINFOA; lSize: longint): HResult; stdcall;

function AVIFileInfo(pfile: IAVIFile; var pfi: TAVIFILEINFO; lSize: longint): HResult; stdcall;

function AVIFileGetStream(pfile: IAVIFile; var ppavi: IAVISTREAM; fccType: DWORD; lParam: longint): HResult; stdcall;
...
function AVIFileWriteData(pfile: IAVIFile; ckid: DWORD; lpData: pointer; cbData: longint): HResult; stdcall;
function AVIFileReadData(pfile: IAVIFile; ckid: DWORD; lpData: pointer; var lpcbData: longint): HResult; stdcall;
...
function AVIStreamInfoW(pavi: IAVIStream; var psi: TAVISTREAMINFOW; lSize: longint): HResult; stdcall;
function AVIStreamInfoA(pavi: IAVIStream; var psi: TAVISTREAMINFOA; lSize: longint): HResult; stdcall;

function AVIStreamInfo(pavi: IAVIStream; var psi: TAVISTREAMINFO; lSize: longint): HResult; stdcall;

function AVIStreamFindSample(pavi: IAVIStream; lPos: longint; lFlags: longint): longint; stdcall;
function AVIStreamReadFormat(pavi: IAVIStream; lPos: longint; lpFormat: pointer; lpcbFormat: PLONGINT): HResult; stdcall;
function AVIStreamSetFormat(pavi: IAVIStream; lPos: longint; lpFormat: pointer; cbFormat: longint): HResult; stdcall;
function AVIStreamReadData(pavi: IAVIStream; fcc: DWORD; lp: pointer; lpcb: PLONGINT): HResult; stdcall;
function AVIStreamWriteData(pavi: IAVIStream; fcc: DWORD; lp: pointer; cb: longint): HResult; stdcall;
...
function AVIStreamWrite(
  ...
  cbBuffer: longint;
  dwFlags: DWORD;
  plSampWritten: PLONGINT;
  plBytesWritten: PLONGINT
  ): HResult; stdcall;

// Right now, these just use AVIStreamInfo() to get information, then
// return some of it.  Can they be more efficient?

function AVIStreamStart(pavi: IAVIStream): longint; stdcall;
function AVIStreamLength(pavi: IAVIStream): longint; stdcall;
function AVIStreamTimeToSample(pavi: IAVIStream; lTime: longint): longint; stdcall;
function AVIStreamSampleToTime(pavi: IAVIStream; lSample: longint): longint; stdcall;

function AVIStreamBeginStreaming(pavi: IAVIStream; lStart, lEnd: longint; lRate: longint): HResult; stdcall;
...
function AVIStreamGetFrame(pg: IGetFrame; lPos: longint): PBitmapInfoHeader; stdcall;
...
function AVIStreamOpenFromFileA(var ppavi: IAVISTREAM; szFile: LPCSTR; fccType: DWORD;
  lParam: longint; mode: UINT; pclsidHandler: PCLSID): HResult; stdcall;
...
function AVIStreamCreate(var ppavi: IAVISTREAM; lParam1, lParam2: longint; pclsidHandler: PCLSID): HResult; stdcall;
...
function AVIStreamFindKeyFrame(var pavi: IAVISTREAM; lPos: longint; lFlags: longint): DWORD; stdcall; // AVIStreamFindSample
...
function AVIStreamSampleToSample(pavi1, pavi2: IAVISTREAM; l: longint): longint;
function AVIStreamNextSample(pavi: IAVISTREAM; l: longint): longint;
function AVIStreamPrevSample(pavi: IAVISTREAM; l: longint): longint;
function AVIStreamNearestSample(pavi: IAVISTREAM; l: longint): longint;
function AVIStreamNextKeyFrame(pavi: IAVISTREAM; l: longint): longint;
function AVIStreamPrevKeyFrame(pavi: IAVISTREAM; l: longint): longint;
function AVIStreamNearestKeyFrame(pavi: IAVISTREAM; l: longint): longint;
function AVIStreamIsKeyFrame(pavi: IAVISTREAM; l: longint): BOOL;
function AVIStreamPrevSampleTime(pavi: IAVISTREAM; t: longint): longint;
function AVIStreamNextSampleTime(pavi: IAVISTREAM; t: longint): longint;
function AVIStreamNearestSampleTime(pavi: IAVISTREAM; t: longint): longint;
function AVIStreamNextKeyFrameTime(pavi: IAVISTREAM; t: longint): longint;
function AVIStreamPrevKeyFrameTime(pavi: IAVISTREAM; t: longint): longint;
function AVIStreamNearestKeyFrameTime(pavi: IAVISTREAM; t: longint): longint;
function AVIStreamStartTime(pavi: IAVISTREAM): longint;
function AVIStreamLengthTime(pavi: IAVISTREAM): longint;
function AVIStreamEnd(pavi: IAVISTREAM): longint;
function AVIStreamEndTime(pavi: IAVISTREAM): longint;
function AVIStreamSampleSize(pavi: IAVISTREAM; lPos: longint; plSize: PLONGINT): longint;
function AVIStreamFormatSize(pavi: IAVISTREAM; lPos: longint; plSize: PLONGINT): HResult;
function AVIStreamDataSize(pavi: IAVISTREAM; fcc: DWORD; plSize: PLONGINT): HResult;

{== AVISave routines and structures ==========================================}

const
  comptypeDIB = $20424944; // mmioFOURCCEx('D', 'I', 'B', ' ')
...
function AVISaveOptionsFree(nStreams: integer; var plpOptions: PAVICOMPRESSOPTIONS): HResult; stdcall;
...
function AVIBuildFilterW(lpszFilter: LPWSTR; cbFilter: longint; fSaving: BOOL): HResult; stdcall;
function AVIBuildFilterA(lpszFilter: LPSTR; cbFilter: longint; fSaving: BOOL): HResult; stdcall;

function AVIBuildFilter(lpszFilter: LPSTR; cbFilter: longint; fSaving: BOOL): HResult; stdcall; // AVIBuildFilterA

function AVIMakeFileFromStreams(var ppfile: IAVIFILE; nStreams: integer; var papStreams: IAVISTREAM): HResult; stdcall;
...
function EditStreamCut(pavi: IAVISTREAM; var plStart, plLength: longint; var ppResult: IAVISTREAM): HResult; stdcall;

function EditStreamCopy(pavi: IAVISTREAM; var plStart, plLength: longint; var ppResult: IAVISTREAM): HResult; stdcall;

function EditStreamPaste(pavi: IAVISTREAM; var plPos, plLength: longint; pstream: IAVISTREAM; lStart, lEnd: longint): HResult; stdcall;
...
function EditStreamSetInfoW(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFOW; cbInfo: longint): HResult; stdcall;
function EditStreamSetInfoA(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFOA; cbInfo: longint): HResult; stdcall;

function EditStreamSetInfo(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFOA; cbInfo: longint): HResult; stdcall; // EditStreamSetInfoA
...
function MCIWndNew(hwnd: HWND; lp: pointer): DWORD;
...
type
  ...
  TCAPSTATUSCALLBACKW = function(hWnd: HWND; nID: integer; lpsz: LPCWSTR): DWORD; stdcall;
  TCAPERRORCALLBACKW = function(hWnd: HWND; nID: integer; lpsz: LPCWSTR): DWORD; stdcall;
  TCAPSTATUSCALLBACKA = function(hWnd: HWND; nID: integer; lpsz: LPCSTR): DWORD; stdcall;
  TCAPERRORCALLBACKA = function(hWnd: HWND; nID: integer; lpsz: LPCSTR): DWORD; stdcall;
  ...
  TCAPCONTROLCALLBACK = function(hWnd: HWND; nState: integer): DWORD; stdcall;
...
function capGetVideoFormat(hwnd: HWND; s: pointer; wSize: WORD): DWORD;
function capGetVideoFormatSize(hwnd: HWND): DWORD;
function capSetVideoFormat(hwnd: HWND; s: pointer; wSize: WORD): BOOL;
...
function capPaletteAuto(hwnd: HWND; iFrames, iColors: integer): BOOL;
function capPaletteManual(hwnd: HWND; fGrab: BOOL; iColors: integer): BOOL;
...
const
  infotypeDIGITIZATION_TIME = $54494449; // mmioFOURCCEx ('I','D','I','T')
  infotypeSMPTE_TIME = $504D5349; // mmioFOURCCEx ('I','S','M','P')
...
function AVIFileInfoW(pfile: IAVIFILE; var pfi: TAVIFILEINFOW; lSize: longint): HResult; stdcall; external AVIFILDLL;

function AVIFileInfoA(pfile: IAVIFILE; var pfi: TAVIFILEINFOA; lSize: longint): HResult; stdcall; external AVIFILDLL;

{$IFDEF UNICODE}

function AVIFileInfo(pfile: IAVIFILE; var pfi: TAVIFILEINFO; lSize: longint): HResult; stdcall; external AVIFILDLL name 'AVIFileInfoW';
{$ELSE}

function AVIFileInfo(pfile: IAVIFILE; var pfi: TAVIFILEINFO; lSize: longint): HResult; stdcall; external AVIFILDLL name 'AVIFileInfoA';
{$ENDIF}

function AVIFileGetStream(pfile: IAVIFILE; var ppavi: IAVISTREAM; fccType: DWORD; lParam: longint): HResult; stdcall; external AVIFILDLL;
...
function AVIFileWriteData(pfile: IAVIFILE; ckid: DWORD; lpData: pointer; cbData: longint): HResult; stdcall; external AVIFILDLL;

function AVIFileReadData(pfile: IAVIFILE; ckid: DWORD; lpData: pointer; var lpcbData: longint): HResult; stdcall; external AVIFILDLL;
...
function AVIStreamInfoW(pavi: IAVISTREAM; var psi: TAVISTREAMINFOW; lSize: longint): HResult; stdcall; external AVIFILDLL;

function AVIStreamInfoA(pavi: IAVISTREAM; var psi: TAVISTREAMINFOA; lSize: longint): HResult; stdcall; external AVIFILDLL;

{$IFDEF UNICODE}

function AVIStreamInfo(pavi: IAVISTREAM; var psi: TAVISTREAMINFO; lSize: longint): HResult; stdcall; external AVIFILDLL name 'AVIStreamInfoW';
{$ELSE}

function AVIStreamInfo(pavi: IAVISTREAM; var psi: TAVISTREAMINFO; lSize: longint): HResult; stdcall; external AVIFILDLL name 'AVIStreamInfoA';
{$ENDIF}

function AVIStreamFindSample(pavi: IAVISTREAM; lPos: longint; lFlags: longint): longint; stdcall; external AVIFILDLL;

function AVIStreamReadFormat(pavi: IAVISTREAM; lPos: longint; lpFormat: pointer; lpcbFormat: PLONGINT): HResult; stdcall; external AVIFILDLL;

function AVIStreamSetFormat(pavi: IAVISTREAM; lPos: longint; lpFormat: pointer; cbFormat: longint): HResult; stdcall; external AVIFILDLL;

function AVIStreamReadData(pavi: IAVISTREAM; fcc: DWORD; lp: pointer; lpcb: PLONGINT): HResult; stdcall; external AVIFILDLL;

function AVIStreamWriteData(pavi: IAVISTREAM; fcc: DWORD; lp: pointer; cb: longint): HResult; stdcall; external AVIFILDLL;
...
function AVIStreamStart(pavi: IAVISTREAM): longint; stdcall; external AVIFILDLL;

function AVIStreamLength(pavi: IAVISTREAM): longint; stdcall; external AVIFILDLL;

function AVIStreamTimeToSample(pavi: IAVISTREAM; lTime: longint): longint; stdcall; external AVIFILDLL;

function AVIStreamSampleToTime(pavi: IAVISTREAM; lSample: longint): longint; stdcall; external AVIFILDLL;

function AVIStreamBeginStreaming(pavi: IAVISTREAM; lStart, lEnd: longint; lRate: longint): HResult; stdcall; external AVIFILDLL;
...
function AVIStreamGetFrame(pg: IGETFRAME; lPos: longint): PBitmapInfoHeader; stdcall; external AVIFILDLL;
...
function AVIStreamOpenFromFileA(var ppavi: IAVISTREAM; szFile: LPCSTR; fccType: DWORD;
  lParam: longint; mode: UINT; pclsidHandler: PCLSID): HResult; stdcall; external AVIFILDLL;
...
function AVIStreamOpenFromFile(var ppavi: IAVISTREAM; szFile: LPCWSTR; fccType: DWORD;
  lParam: longint; mode: UINT; pclsidHandler: PCLSID): HResult; stdcall; external AVIFILDLL name 'AVIStreamOpenFromFileW';
{$ELSE}

function AVIStreamOpenFromFile(var ppavi: IAVISTREAM; szFile: LPCSTR; fccType: DWORD;
  lParam: longint; mode: UINT; pclsidHandler: PCLSID): HResult; stdcall; external AVIFILDLL name 'AVIStreamOpenFromFileA';
{$ENDIF}

{-- Use to create disembodied streams ----------------------------------------}

function AVIStreamCreate(var ppavi: IAVISTREAM; lParam1, lParam2: longint;
...
function AVIStreamFindKeyFrame(var pavi: IAVISTREAM; lPos: longint; lFlags: longint): DWORD; stdcall; external AVIFILDLL name 'AVIStreamFindSample';
...
function AVISaveOptionsFree(nStreams: integer; var plpOptions: PAVICOMPRESSOPTIONS): HResult; stdcall; external AVIFILDLL;

{-----------------------------------------------------------------------------}

function AVIBuildFilterW(lpszFilter: LPWSTR; cbFilter: longint; fSaving: BOOL): HResult; stdcall; external AVIFILDLL;

function AVIBuildFilterA(lpszFilter: LPSTR; cbFilter: longint; fSaving: BOOL): HResult; stdcall; external AVIFILDLL;

function AVIBuildFilter(lpszFilter: LPSTR; cbFilter: longint; fSaving: BOOL): HResult; stdcall; external AVIFILDLL name 'AVIBuildFilterA';

function AVIMakeFileFromStreams(var ppfile: IAVIFILE; nStreams: integer; var papStreams: IAVISTREAM): HResult; stdcall; external AVIFILDLL;
...
function EditStreamCut(pavi: IAVISTREAM; var plStart, plLength: longint; var ppResult: IAVISTREAM): HResult; stdcall; external AVIFILDLL;

function EditStreamCopy(pavi: IAVISTREAM; var plStart, plLength: longint; var ppResult: IAVISTREAM): HResult; stdcall; external AVIFILDLL;

function EditStreamPaste(pavi: IAVISTREAM; var plPos, plLength: longint; pstream: IAVISTREAM; lStart, lEnd: longint): HResult; stdcall; external AVIFILDLL;
...
function EditStreamSetInfoW(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFOW; cbInfo: longint): HResult; stdcall; external AVIFILDLL;

function EditStreamSetInfoA(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFOA; cbInfo: longint): HResult; stdcall; external AVIFILDLL;

function EditStreamSetInfo(pavi: IAVISTREAM; lpInfo: PAVISTREAMINFOA; cbInfo: longint): HResult; stdcall; external AVIFILDLL name 'EditStreamSetInfoA';
