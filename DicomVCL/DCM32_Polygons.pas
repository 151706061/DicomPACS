...
{$ELSE}
  Windows,
{$ENDIF}
  Classes, SysUtils, DCM32, DCM32_LowLevel, DCM32_Blend, DCM32_Transforms;

{ Polylines }

procedure PolylineTS(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
  Color: TColor32; Closed: Boolean = False; Transformation: TTransformation = nil);
procedure PolylineAS(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
  Color: TColor32; Closed: Boolean = False; Transformation: TTransformation = nil);
procedure PolylineXS(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
  Color: TColor32; Closed: Boolean = False; Transformation: TTransformation = nil);
procedure PolylineXSP(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
  Closed: Boolean = False; Transformation: TTransformation = nil);

procedure PolyPolylineTS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  Color: TColor32; Closed: Boolean = False; Transformation: TTransformation = nil);
procedure PolyPolylineAS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  Color: TColor32; Closed: Boolean = False; Transformation: TTransformation = nil);
procedure PolyPolylineXS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  Color: TColor32; Closed: Boolean = False; Transformation: TTransformation = nil);
procedure PolyPolylineXSP(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  Closed: Boolean = False; Transformation: TTransformation = nil);
...
procedure PolygonTS(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
...
procedure PolygonXS(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
...
procedure PolyPolygonTS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  Color: TColor32; Mode: TPolyFillMode = pfAlternate; Transformation: TTransformation = nil); overload;
procedure PolyPolygonTS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  FillLineCallback: TFillLineEvent; Mode: TPolyFillMode = pfAlternate; Transformation: TTransformation = nil); overload;
procedure PolyPolygonTS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
...
procedure PolyPolygonXS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  Color: TColor32; Mode: TPolyFillMode = pfAlternate;
  const AAMode: TAntialiasMode = DefaultAAMode; Transformation: TTransformation = nil); overload;
procedure PolyPolygonXS(Bitmap: TCnsBitmap32; const Points: TArrayOfArrayOfFixedPoint;
  FillLineCallback: TFillLineEvent; Mode: TPolyFillMode = pfAlternate;
...
type
  ...
  public
    ...
    procedure Draw(Bitmap: TCnsBitmap32; OutlineColor, FillColor: TColor32; Transformation: TTransformation = nil); overload;
    procedure Draw(Bitmap: TCnsBitmap32; OutlineColor: TColor32; FillCallback: TFillLineEvent; Transformation: TTransformation = nil); overload;
    procedure Draw(Bitmap: TCnsBitmap32; OutlineColor: TColor32; Filler: TCustomPolygonFiller; Transformation: TTransformation = nil); overload;

    procedure DrawEdge(Bitmap: TCnsBitmap32; Color: TColor32; Transformation: TTransformation = nil);

    procedure DrawFill(Bitmap: TCnsBitmap32; Color: TColor32; Transformation: TTransformation = nil); overload;
    procedure DrawFill(Bitmap: TCnsBitmap32; FillCallback: TFillLineEvent; Transformation: TTransformation = nil); overload;
    procedure DrawFill(Bitmap: TCnsBitmap32; Filler: TCustomPolygonFiller; Transformation: TTransformation = nil); overload;
  ...
  public
    property Pattern: TCnsBitmap32 read FPattern write FPattern;
...
type
  TCnsBitmap32Access = class(TCnsBitmap32);
...
procedure ColorFillLines(Bitmap: TCnsBitmap32; BaseY: Integer;
...
procedure ColorFillLines2(Bitmap: TCnsBitmap32; BaseY: Integer;
  const ScanLines: TScanLines; Color: TColor32; Mode: TPolyFillMode;
...
begin
  ...
  begin
    ...
    begin
      ...
      BlendLineEx(@ColorBuffer[0], Pointer(Bitmap.PixelPtr[MinX, Y]), Min(BufferSize, Bitmap.Width - MinX), A);
      EMMS;
    end;
...
procedure CustomFillLines(Bitmap: TCnsBitmap32; BaseY: Integer;
...
procedure CustomFillLines2(Bitmap: TCnsBitmap32; BaseY: Integer;
  const ScanLines: TScanLines; FillLineCallback: TFillLineEvent; Mode: TPolyFillMode;
  const AAMode: TAntialiasMode = DefaultAAMode);
var
  I, J, L, N: Integer;
...
procedure RenderPolygonTS(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
...
begin
  ...
  Bitmap.ChangedEx(MakeRect(PolygonBounds(Points), rrOutside));
end;
...
// only used internally to share code:
procedure RenderPolygonXS(Bitmap: TCnsBitmap32; const Points: TArrayOfFixedPoint;
  Color: TColor32; FillLineCallback: TFillLineEvent; Mode: TPolyFillMode;
...
// only used internally to share code:
procedure RenderPolyPolygonTS(Bitmap: TCnsBitmap32;
...
begin
  ...
  Bitmap.ChangedEx(MakeRect(PolyPolygonBounds(Points), rrOutside));
end;

procedure PolyPolygonTS(Bitmap: TCnsBitmap32;
...
// only used internally to share code:
procedure RenderPolyPolygonXS(Bitmap: TCnsBitmap32;
  const Points: TArrayOfArrayOfFixedPoint; Color: TColor32;
  FillLineCallback: TFillLineEvent; Mode: TPolyFillMode;
  const AAMode: TAntialiasMode; Transformation: TTransformation);
var
...
procedure PolyPolygonXS(Bitmap: TCnsBitmap32;
  const Points: TArrayOfArrayOfFixedPoint; Color: TColor32; Mode: TPolyFillMode;
  const AAMode: TAntialiasMode; Transformation: TTransformation);
begin
...
procedure TPolygon32.Draw(Bitmap: TCnsBitmap32; OutlineColor, FillColor: TColor32; Transformation: TTransformation);
begin
  Bitmap.BeginUpdate;
...
procedure TPolygon32.Draw(Bitmap: TCnsBitmap32; OutlineColor: TColor32;
...
procedure TPolygon32.DrawEdge(Bitmap: TCnsBitmap32; Color: TColor32; Transformation: TTransformation);
begin
  Bitmap.BeginUpdate;
...
procedure TPolygon32.DrawFill(Bitmap: TCnsBitmap32; Color: TColor32; Transformation: TTransformation);
begin
  Bitmap.BeginUpdate;
...
procedure TPolygon32.DrawFill(Bitmap: TCnsBitmap32; FillCallback: TFillLineEvent;
  Transformation: TTransformation);
begin
  Bitmap.BeginUpdate;
...
procedure TPolygon32.DrawFill(Bitmap: TCnsBitmap32; Filler: TCustomPolygonFiller;
  Transformation: TTransformation);
begin
