...
uses
  ...
  Windows,
  {$ENDIF}
  SysUtils, Classes, DCM32, DCM32_Blend;
...
procedure Transform(Dst, Src: TCnsBitmap32; Transformation: TTransformation); overload;
procedure Transform(Dst, Src: TCnsBitmap32; Transformation: TTransformation;
...
procedure SetBorderTransparent(ABitmap: TCnsBitmap32; ARect: TRect);
...
uses
  DCM32_LowLevel, DCM32_System, DCM32_Resamplers, Math;

type
  {provides access to proctected members of TCnsBitmap32 by typecasting}
...
procedure Transform(Dst, Src: TCnsBitmap32; Transformation: TTransformation; const DstClip: TRect);
var
  Rasterizer: TRasterizer;
begin
  Rasterizer := DefaultRasterizerClass.Create;
...
begin
  DCM32.SinCos(FPiH * DstY, SinY, CosY);
  DCM32.SinCos(FPiW * DstX, SinX, CosX);
  t := FBP * SinY * SinX;
  SrcX := DstX + t * CosX;
  SrcY := DstY + t * CosY;
end;
