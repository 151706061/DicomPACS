...
begin
  ...
  //$2813, $0110 ∫¨±£¥ÊÕºœÒ ±ÿ–ÎµƒœÓƒø  8,$10,$18,$20,$28
...
begin
  ...
  begin
    ...
    begin
      Add('TABLEGROUP ƒ⁄≤ø{TABLE ÕºœÒµ•( STUDIES){');
      Add('    PLUGIN IS ∆’Õ®');
      Add('    AUTOCREATE');
  ...
  begin
    ...
    begin
      Add('TABLEGROUP ƒ⁄≤ø{TABLE ÕºœÒÀ˜“˝( IMAGES){');
      Add('  PLUGIN IS ∆’Õ®');
      Add('  AUTOCREATE');
      //  Add('  MULTIDATABASE');
...
begin
  ...
  case ARequestType of
    ...
    C_MOVE_REQUEST:
      begin
        // FOMIN 08_07_2012 MoveDestination
        // ‚ÒÚ‡‚ËÎË Ò‚ÓÈÒÚ‚Ó FMoveDestination
        // ÂÒÎË ÌÂ Á‡‰‡ÌÓ - Í‡Í ‡Ì¸¯Â - ËÁ FCallingTitle
  ...
  try
    try
      ...
      begin
        ...
        MessageDlg('Œ¯Ë·Í‡ Á‡ÔÓÒ‡ DICOM : '+e.Message, mtWarning, [mbOK], 0);
  ...
  begin
    ...
    begin
      ...
      if FCanRetryConnected and
        ...
        + #13#10 + dcmAssociationRetryConnect) then
      begin
        //      if QueryHost(Format('¡¨Ω”µΩ∑˛ŒÒ∆˜%s:%d≤ª≥…π¶!«ÎºÏ≤Èƒ„µƒÕ¯¬Á…Ë÷√°¢Õ¯ø®º∞Õ¯œﬂº∞¡™œµπ‹¿Ì‘±◊…—Ø°£', [Host, Port]) + dcmAssociationRetryConnect) then
        goto RetryConnect;
      end
      else
        raise Exception.Create(V_CONNECT_ABORT_ERROR);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        {        if (ff1.Parent.name <> 'ƒ¨»œ') and (ff1.Parent.name <> 'ºÃ≥–') then
                begin
