...
USEFORMNS("DicomInputQuery.pas", Dicominputquery, DicomInputQueryForm);
USEFORMNS("SurfaceInProcessing.pas", Surfaceinprocessing, RenderingProcessBarForm);
USEFORMNS("VideoConferenceBaseForm.pas", Videoconferencebaseform, VideoConferenceForm);
USEFORMNS("VolumeSelectRange.pas", Volumeselectrange, SelectRangeForm);
//---------------------------------------------------------------------------
