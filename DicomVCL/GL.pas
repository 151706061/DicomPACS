...
var
  ...
  glGetBooleanv: procedure(pname: GLenum; var params: GLboolean); stdcall;
  glGetClipPlane: procedure(plane: GLenum; var equation: GLdouble); stdcall;
  glGetDoublev: procedure(pname: GLenum; var params: GLdouble); stdcall;
  glGetError: function: GLenum; stdcall;
  glGetFloatv: procedure(pname: GLenum; var params: GLfloat); stdcall;
  glGetIntegerv: procedure(pname: GLenum; var params: GLint); stdcall;
  glGetLightfv: procedure(light, pname: GLenum; var params: GLfloat); stdcall;
  glGetLightiv: procedure(light, pname: GLenum; var params: GLint); stdcall;
  glGetMapdv: procedure(target, query: GLenum; var v: GLdouble); stdcall;
  glGetMapfv: procedure(target, query: GLenum; var v: GLfloat); stdcall;
  glGetMapiv: procedure(target, query: GLenum; v: GLint); stdcall;
  glGetMaterialfv: procedure(face, pname: GLenum; var params: GLfloat); stdcall;
  glGetMaterialiv: procedure(face, pname: GLenum; params: GLint); stdcall;
  glGetPixelMapfv: procedure(map: GLenum; var values: GLfloat); stdcall;
  glGetPixelMapuiv: procedure(map: GLenum; var values: GLuint); stdcall;
