...
begin
  ...
  if not Assigned(glTexSubImage3D) then
    Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glSeparableFilter2D) then
      Exit;
    ...
    if not Assigned(glHistogram) then
      Exit;
    glMinmax := wglGetProcAddress('glMinmax');
    if not Assigned(glMinmax) then
      Exit;
    glResetHistogram := wglGetProcAddress('glResetHistogram');
    if not Assigned(glResetHistogram) then
      Exit;
    glResetMinmax := wglGetProcAddress('glResetMinmax');
    if not Assigned(glResetMinmax) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glSampleCoverageARB) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glPointParameterfARB) then
      Exit;
    glPointParameterfvARB := wglGetProcAddress('glPointParameterfvARB');
    if not Assigned(glPointParameterfvARB) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glVertexAttrib1sARB) then
      Exit;
    glVertexAttrib1fARB := wglGetProcAddress('glVertexAttrib1fARB');
    if not Assigned(glVertexAttrib1fARB) then
      Exit;
    ...
    if not Assigned(glProgramStringARB) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glLockArraysEXT) then
      Exit;
    glUnlockArraysEXT := wglGetProcAddress('glUnlockArraysEXT');
    if not Assigned(glUnlockArraysEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glSeparableFilter2DEXT) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glHistogramEXT) then
      Exit;
    glResetHistogramEXT := wglGetProcAddress('glResetHistogramEXT');
    if not Assigned(glResetHistogramEXT) then
      Exit;
    ...
    if not Assigned(glMinmaxEXT) then
      Exit;
    glResetMinmaxEXT := wglGetProcAddress('glResetMinmaxEXT');
    if not Assigned(glResetMinmaxEXT) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glPointParameterfEXT) then
      Exit;
    glPointParameterfvEXT := wglGetProcAddress('glPointParameterfvEXT');
    if not Assigned(glPointParameterfvEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glPolygonOffsetEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glTexSubImage1DEXT) then
      Exit;
    glTexSubImage2DEXT := wglGetProcAddress('glTexSubImage2DEXT');
    if not Assigned(glTexSubImage2DEXT) then
      Exit;
    glTexSubImage3DEXT := wglGetProcAddress('glTexSubImage3DEXT');
    if not Assigned(glTexSubImage3DEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glTexImage3DEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glPrioritizeTexturesEXT) then
      Exit;
    ...
    if not Assigned(glIsTextureEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glVertexPointerEXT) then
      Exit;
    glNormalPointerEXT := wglGetProcAddress('glNormalPointerEXT');
    if not Assigned(glNormalPointerEXT) then
      Exit;
    ...
    if not Assigned(glIndexPointerEXT) then
      Exit;
    glTexCoordPointerEXT := wglGetProcAddress('glTexCoordPointerEXT');
    if not Assigned(glTexCoordPointerEXT) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glVertexWeightfEXT) then
      Exit;
    glVertexWeightfvEXT := wglGetProcAddress('glVertexWeightfvEXT');
    if not Assigned(glVertexWeightfvEXT) then
      Exit;
    glVertexWeightPointerEXT := wglGetProcAddress('glVertexWeightPointerEXT');
    if not Assigned(glVertexWeightPointerEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glMapControlPointsNV) then
      Exit;
    glMapParameterivNV := wglGetProcAddress('glMapParameterivNV');
    if not Assigned(glMapParameterivNV) then
      Exit;
    glMapParameterfvNV := wglGetProcAddress('glMapParameterfvNV');
    if not Assigned(glMapParameterfvNV) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glSetFenceNV) then
      Exit;
    glTestFenceNV := wglGetProcAddress('glTestFenceNV');
    if not Assigned(glTestFenceNV) then
      Exit;
    ...
    if not Assigned(glIsFenceNV) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glIsOcclusionQueryNV) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glPointParameteriNV) then
      Exit;
    glPointParameterivNV := wglGetProcAddress('glPointParameterivNV');
    if not Assigned(glPointParameterivNV) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glVertexArrayRangeNV) then
      Exit;
    ...
    if not Assigned(wglAllocateMemoryNV) then
      Exit;
    wglFreeMemoryNV := wglGetProcAddress('wglFreeMemoryNV');
    if not Assigned(wglFreeMemoryNV) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glRequestResidentProgramsNV) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glTexBumpParameterivATI) then
      Exit;
    glTexBumpParameterfvATI := wglGetProcAddress('glTexBumpParameterfvATI');
    if not Assigned(glTexBumpParameterfvATI) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glPassTexCoordATI) then
      Exit;
    glSampleMapATI := wglGetProcAddress('glSampleMapATI');
    if not Assigned(glSampleMapATI) then
      Exit;
    ...
    if not Assigned(glSetFragmentShaderConstantATI) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glPNTrianglesiATI) then
      Exit;
    glPNTrianglesfATI := wglGetProcAddress('glPNTrianglesfATI');
    if not Assigned(glPNTrianglesfATI) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glNewObjectBufferATI) then
      Exit;
    glIsObjectBufferATI := wglGetProcAddress('glIsObjectBufferATI');
    if not Assigned(glIsObjectBufferATI) then
      Exit;
    glUpdateObjectBufferATI := wglGetProcAddress('glUpdateObjectBufferATI');
    if not Assigned(glUpdateObjectBufferATI) then
      Exit;
    ...
    if not Assigned(glDeleteObjectBufferATI) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glMultiModeDrawArraysIBM) then
      Exit;
    glMultiModeDrawElementsIBM := wglGetProcAddress('glMultiModeDrawElementsIBM');
    if not Assigned(glMultiModeDrawElementsIBM) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glSecondaryColorPointerListIBM) then
      Exit;
    ...
    if not Assigned(glNormalPointerListIBM) then
      Exit;
    glTexCoordPointerListIBM := wglGetProcAddress('glTexCoordPointerListIBM');
    if not Assigned(glTexCoordPointerListIBM) then
      Exit;
    glVertexPointerListIBM := wglGetProcAddress('glVertexPointerListIBM');
    if not Assigned(glVertexPointerListIBM) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glSampleMaskSGIS) then
      Exit;
    glSamplePatternSGIS := wglGetProcAddress('glSamplePatternSGIS');
    if not Assigned(glSamplePatternSGIS) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glPixelTexGenParameteriSGIS) then
      Exit;
    glPixelTexGenParameterfSGIS := wglGetProcAddress('glPixelTexGenParameterfSGIS');
    if not Assigned(glPixelTexGenParameterfSGIS) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glTextureColorMaskSGIS) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glNormal3fVertex3fSUN) then
      Exit;
    glNormal3fVertex3fvSUN := wglGetProcAddress('glNormal3fVertex3fvSUN');
    if not Assigned(glNormal3fVertex3fvSUN) then
      Exit;
    ...
    if not Assigned(glTexCoord2fVertex3fSUN) then
      Exit;
    glTexCoord2fVertex3fvSUN := wglGetProcAddress('glTexCoord2fVertex3fvSUN');
    if not Assigned(glTexCoord2fVertex3fvSUN) then
      Exit;
    ...
    if not Assigned(glReplacementCodeuiTexCoord2fColor4fNormal3fVertex3fSUN) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glMultiDrawElementArrayAPPLE) then
      Exit;
    glMultiDrawRangeElementArrayAPPLE := wglGetProcAddress('glMultiDrawRangeElementArrayAPPLE');
    if not Assigned(glMultiDrawRangeElementArrayAPPLE) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glSetFenceAPPLE) then
      Exit;
    glIsFenceAPPLE := wglGetProcAddress('glIsFenceAPPLE');
    if not Assigned(glIsFenceAPPLE) then
      Exit;
    glTestFenceAPPLE := wglGetProcAddress('glTestFenceAPPLE');
    if not Assigned(glTestFenceAPPLE) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glIsVertexArrayAPPLE) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glVertexArrayRangeAPPLE) then
      Exit;
    ...
    if not Assigned(glVertexArrayParameteriAPPLE) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(wglGetPixelFormatAttribivARB) then
      Exit;
    wglGetPixelFormatAttribfvARB := wglGetProcAddress('wglGetPixelFormatAttribfvARB');
    if not Assigned(wglGetPixelFormatAttribfvARB) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(wglMakeContextCurrentARB) then
      Exit;
    wglGetCurrentReadDCARB := wglGetProcAddress('wglGetCurrentReadDCARB');
    if not Assigned(wglGetCurrentReadDCARB) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(wglGetSwapIntervalEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(wglBindTexImageARB) then
      Exit;
    wglReleaseTexImageARB := wglGetProcAddress('wglReleaseTexImageARB');
    if not Assigned(wglReleaseTexImageARB) then
      Exit;
    wglSetPbufferAttribARB := wglGetProcAddress('wglSetPbufferAttribARB');
    if not Assigned(wglSetPbufferAttribARB) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(wglMakeContextCurrentEXT) then
      Exit;
    wglGetCurrentReadDCEXT := wglGetProcAddress('wglGetCurrentReadDCEXT');
    if not Assigned(wglGetCurrentReadDCEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(wglGetPixelFormatAttribivEXT) then
      Exit;
    wglGetPixelFormatAttribfvEXT := wglGetProcAddress('wglGetPixelFormatAttribfvEXT');
    if not Assigned(wglGetPixelFormatAttribfvEXT) then
      Exit;
    wglChoosePixelFormatEXT := wglGetProcAddress('wglChoosePixelFormatEXT');
    if not Assigned(wglChoosePixelFormatEXT) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(wglGetDigitalVideoParametersI3D) then
      Exit;
    wglSetDigitalVideoParametersI3D := wglGetProcAddress('wglSetDigitalVideoParametersI3D');
    if not Assigned(wglSetDigitalVideoParametersI3D) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glProgramNamedParameter4fNV) then
      Exit;
    glProgramNamedParameter4dNV := wglGetProcAddress('glProgramNamedParameter4dNV');
    if not Assigned(glProgramNamedParameter4dNV) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glPrimitiveRestartNV) then
      Exit;
    glPrimitiveRestartIndexNV := wglGetProcAddress('glPrimitiveRestartIndexNV');
    if not Assigned(glPrimitiveRestartIndexNV) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glPixelDataRangeNV) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glMapObjectBufferATI) then
      Exit;
    glUnmapObjectBufferATI := wglGetProcAddress('glUnmapObjectBufferATI');
    if not Assigned(glUnmapObjectBufferATI) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glStencilOpSeparateATI) then
      Exit;
    glStencilFuncSeparateATI := wglGetProcAddress('glStencilFuncSeparateATI');
    if not Assigned(glStencilFuncSeparateATI) then
      Exit;
    Result := TRUE;
  end;
...
begin
  ...
  begin
    ...
    if not Assigned(glIsBufferARB) then
      Exit;
    ...
    if not Assigned(glMapBufferARB) then
      Exit;
    glUnmapBufferARB := wglGetProcAddress('glUnmapBufferARB');
    if not Assigned(glUnmapBufferARB) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glIsQueryARB) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glShaderSourceARB) then
      Exit;
    ...
    if not Assigned(glGetUniformLocationARB) then
      Exit;
    ...
    if not Assigned(glGetUniformfvARB) then
      Exit;
    glGetUniformivARB := wglGetProcAddress('glGetUniformivARB');
    if not Assigned(glGetUniformivARB) then
      Exit;
...
begin
  ...
  begin
    ...
    if not Assigned(glIsRenderbufferEXT) then
      Exit;
    ...
    if not Assigned(glRenderbufferStorageEXT) then
      Exit;
    ...
    if not Assigned(glIsFramebufferEXT) then
      Exit;
...
begin
  ...
  if not Assigned(glIsQuery) then
    Exit;
  ...
  if not Assigned(glIsBuffer) then
    Exit;
  ...
  if not Assigned(glMapBuffer) then
    Exit;
  glUnmapBuffer := wglGetProcAddress('glUnmapBuffer');
  if not Assigned(glUnmapBuffer) then
    Exit;
...
begin
  ...
  if not Assigned(glStencilOpSeparate) then
    Exit;
  glStencilFuncSeparate := wglGetProcAddress('glStencilFuncSeparate');
  if not Assigned(glStencilFuncSeparate) then
    Exit;
  glStencilMaskSeparate := wglGetProcAddress('glStencilMaskSeparate');
  if not Assigned(glStencilMaskSeparate) then
    Exit;
...
begin
  ...
  if ext = 'GL_version_1_2' then
    Result := Load_GL_version_1_2
  else
    if ext = 'GL_ARB_imaging' then
    Result := Load_GL_ARB_imaging
  else
    if ext = 'GL_version_1_3' then
    Result := Load_GL_version_1_3
  else
    if ext = 'GL_ARB_multitexture' then
    Result := Load_GL_ARB_multitexture
  else
    if ext = 'GL_ARB_transpose_matrix' then
    Result := Load_GL_ARB_transpose_matrix
  else
    if ext = 'GL_ARB_multisample' then
    Result := Load_GL_ARB_multisample
  else
    if ext = 'GL_ARB_texture_env_add' then
    Result := Load_GL_ARB_texture_env_add
  else
    if ext = 'WGL_ARB_extensions_string' then
    Result := Load_WGL_ARB_extensions_string
  else
    if ext = 'WGL_ARB_buffer_region' then
    Result := Load_WGL_ARB_buffer_region
  else
    if ext = 'GL_ARB_texture_cube_map' then
    Result := Load_GL_ARB_texture_cube_map
  else
    if ext = 'GL_ARB_depth_texture' then
    Result := Load_GL_ARB_depth_texture
  else
    if ext = 'GL_ARB_point_parameters' then
    Result := Load_GL_ARB_point_parameters
  else
    if ext = 'GL_ARB_shadow' then
    Result := Load_GL_ARB_shadow
  else
    if ext = 'GL_ARB_shadow_ambient' then
    Result := Load_GL_ARB_shadow_ambient
  else
    if ext = 'GL_ARB_texture_border_clamp' then
    Result := Load_GL_ARB_texture_border_clamp
  else
    if ext = 'GL_ARB_texture_compression' then
    Result := Load_GL_ARB_texture_compression
  else
    if ext = 'GL_ARB_texture_env_combine' then
    Result := Load_GL_ARB_texture_env_combine
  else
    if ext = 'GL_ARB_texture_env_crossbar' then
    Result := Load_GL_ARB_texture_env_crossbar
  else
    if ext = 'GL_ARB_texture_env_dot3' then
    Result := Load_GL_ARB_texture_env_dot3
  else
    if ext = 'GL_ARB_texture_mirrored_repeat' then
    Result := Load_GL_ARB_texture_mirrored_repeat
  else
    if ext = 'GL_ARB_vertex_blend' then
    Result := Load_GL_ARB_vertex_blend
  else
    if ext = 'GL_ARB_vertex_program' then
    Result := Load_GL_ARB_vertex_program
  else
    if ext = 'GL_ARB_window_pos' then
    Result := Load_GL_ARB_window_pos
  else
    if ext = 'GL_EXT_422_pixels' then
    Result := Load_GL_EXT_422_pixels
  else
    if ext = 'GL_EXT_abgr' then
    Result := Load_GL_EXT_abgr
  else
    if ext = 'GL_EXT_bgra' then
    Result := Load_GL_EXT_bgra
  else
    if ext = 'GL_EXT_blend_color' then
    Result := Load_GL_EXT_blend_color
  else
    if ext = 'GL_EXT_blend_func_separate' then
    Result := Load_GL_EXT_blend_func_separate
  else
    if ext = 'GL_EXT_blend_logic_op' then
    Result := Load_GL_EXT_blend_logic_op
  else
    if ext = 'GL_EXT_blend_minmax' then
    Result := Load_GL_EXT_blend_minmax
  else
    if ext = 'GL_EXT_blend_subtract' then
    Result := Load_GL_EXT_blend_subtract
  else
    if ext = 'GL_EXT_clip_volume_hint' then
    Result := Load_GL_EXT_clip_volume_hint
  else
    if ext = 'GL_EXT_color_subtable' then
    Result := Load_GL_EXT_color_subtable
  else
    if ext = 'GL_EXT_compiled_vertex_array' then
    Result := Load_GL_EXT_compiled_vertex_array
  else
    if ext = 'GL_EXT_convolution' then
    Result := Load_GL_EXT_convolution
  else
    if ext = 'GL_EXT_histogram' then
    Result := Load_GL_EXT_histogram
  else
    if ext = 'GL_EXT_multi_draw_arrays' then
    Result := Load_GL_EXT_multi_draw_arrays
  else
    if ext = 'GL_EXT_packed_pixels' then
    Result := Load_GL_EXT_packed_pixels
  else
    if ext = 'GL_EXT_paletted_texture' then
    Result := Load_GL_EXT_paletted_texture
  else
    if ext = 'GL_EXT_point_parameters' then
    Result := Load_GL_EXT_point_parameters
  else
    if ext = 'GL_EXT_polygon_offset' then
    Result := Load_GL_EXT_polygon_offset
  else
    if ext = 'GL_EXT_separate_specular_color' then
    Result := Load_GL_EXT_separate_specular_color
  else
    if ext = 'GL_EXT_shadow_funcs' then
    Result := Load_GL_EXT_shadow_funcs
  else
    if ext = 'GL_EXT_shared_texture_palette' then
    Result := Load_GL_EXT_shared_texture_palette
  else
    if ext = 'GL_EXT_stencil_two_side' then
    Result := Load_GL_EXT_stencil_two_side
  else
    if ext = 'GL_EXT_stencil_wrap' then
    Result := Load_GL_EXT_stencil_wrap
  else
    if ext = 'GL_EXT_subtexture' then
    Result := Load_GL_EXT_subtexture
  else
    if ext = 'GL_EXT_texture3D' then
    Result := Load_GL_EXT_texture3D
  else
    if ext = 'GL_EXT_texture_compression_s3tc' then
    Result := Load_GL_EXT_texture_compression_s3tc
  else
    if ext = 'GL_EXT_texture_env_add' then
    Result := Load_GL_EXT_texture_env_add
  else
    if ext = 'GL_EXT_texture_env_combine' then
    Result := Load_GL_EXT_texture_env_combine
  else
    if ext = 'GL_EXT_texture_env_dot3' then
    Result := Load_GL_EXT_texture_env_dot3
  else
    if ext = 'GL_EXT_texture_filter_anisotropic' then
    Result := Load_GL_EXT_texture_filter_anisotropic
  else
    if ext = 'GL_EXT_texture_lod_bias' then
    Result := Load_GL_EXT_texture_lod_bias
  else
    if ext = 'GL_EXT_texture_object' then
    Result := Load_GL_EXT_texture_object
  else
    if ext = 'GL_EXT_vertex_array' then
    Result := Load_GL_EXT_vertex_array
  else
    if ext = 'GL_EXT_vertex_shader' then
    Result := Load_GL_EXT_vertex_shader
  else
    if ext = 'GL_EXT_vertex_weighting' then
    Result := Load_GL_EXT_vertex_weighting
  else
    if ext = 'GL_HP_occlusion_test' then
    Result := Load_GL_HP_occlusion_test
  else
    if ext = 'GL_NV_blend_square' then
    Result := Load_GL_NV_blend_square
  else
    if ext = 'GL_NV_copy_depth_to_color' then
    Result := Load_GL_NV_copy_depth_to_color
  else
    if ext = 'GL_NV_depth_clamp' then
    Result := Load_GL_NV_depth_clamp
  else
    if ext = 'GL_NV_evaluators' then
    Result := Load_GL_NV_evaluators
  else
    if ext = 'GL_NV_fence' then
    Result := Load_GL_NV_fence
  else
    if ext = 'GL_NV_fog_distance' then
    Result := Load_GL_NV_fog_distance
  else
    if ext = 'GL_NV_light_max_exponent' then
    Result := Load_GL_NV_light_max_exponent
  else
    if ext = 'GL_NV_multisample_filter_hint' then
    Result := Load_GL_NV_multisample_filter_hint
  else
    if ext = 'GL_NV_occlusion_query' then
    Result := Load_GL_NV_occlusion_query
  else
    if ext = 'GL_NV_packed_depth_stencil' then
    Result := Load_GL_NV_packed_depth_stencil
  else
    if ext = 'GL_NV_point_sprite' then
    Result := Load_GL_NV_point_sprite
  else
    if ext = 'GL_NV_register_combiners' then
    Result := Load_GL_NV_register_combiners
  else
    if ext = 'GL_NV_register_combiners2' then
    Result := Load_GL_NV_register_combiners2
  else
    if ext = 'GL_NV_texgen_emboss' then
    Result := Load_GL_NV_texgen_emboss
  else
    if ext = 'GL_NV_texgen_reflection' then
    Result := Load_GL_NV_texgen_reflection
  else
    if ext = 'GL_NV_texture_compression_vtc' then
    Result := Load_GL_NV_texture_compression_vtc
  else
    if ext = 'GL_NV_texture_env_combine4' then
    Result := Load_GL_NV_texture_env_combine4
  else
    if ext = 'GL_NV_texture_rectangle' then
    Result := Load_GL_NV_texture_rectangle
  else
    if ext = 'GL_NV_texture_shader' then
    Result := Load_GL_NV_texture_shader
  else
    if ext = 'GL_NV_texture_shader2' then
    Result := Load_GL_NV_texture_shader2
  else
    if ext = 'GL_NV_texture_shader3' then
    Result := Load_GL_NV_texture_shader3
  else
    if ext = 'GL_NV_vertex_array_range' then
    Result := Load_GL_NV_vertex_array_range
  else
    if ext = 'GL_NV_vertex_array_range2' then
    Result := Load_GL_NV_vertex_array_range2
  else
    if ext = 'GL_NV_vertex_program' then
    Result := Load_GL_NV_vertex_program
  else
    if ext = 'GL_NV_vertex_program1_1' then
    Result := Load_GL_NV_vertex_program1_1
  else
    if ext = 'GL_ATI_element_array' then
    Result := Load_GL_ATI_element_array
  else
    if ext = 'GL_ATI_envmap_bumpmap' then
    Result := Load_GL_ATI_envmap_bumpmap
  else
    if ext = 'GL_ATI_fragment_shader' then
    Result := Load_GL_ATI_fragment_shader
  else
    if ext = 'GL_ATI_pn_triangles' then
    Result := Load_GL_ATI_pn_triangles
  else
    if ext = 'GL_ATI_texture_mirror_once' then
    Result := Load_GL_ATI_texture_mirror_once
  else
    if ext = 'GL_ATI_vertex_array_object' then
    Result := Load_GL_ATI_vertex_array_object
  else
    if ext = 'GL_ATI_vertex_streams' then
    Result := Load_GL_ATI_vertex_streams
  else
    if ext = 'WGL_I3D_image_buffer' then
    Result := Load_WGL_I3D_image_buffer
  else
    if ext = 'WGL_I3D_swap_frame_lock' then
    Result := Load_WGL_I3D_swap_frame_lock
  else
    if ext = 'WGL_I3D_swap_frame_usage' then
    Result := Load_WGL_I3D_swap_frame_usage
  else
    if ext = 'GL_3DFX_texture_compression_FXT1' then
    Result := Load_GL_3DFX_texture_compression_FXT1
  else
    if ext = 'GL_IBM_cull_vertex' then
    Result := Load_GL_IBM_cull_vertex
  else
    if ext = 'GL_IBM_multimode_draw_arrays' then
    Result := Load_GL_IBM_multimode_draw_arrays
  else
    if ext = 'GL_IBM_raster_pos_clip' then
    Result := Load_GL_IBM_raster_pos_clip
  else
    if ext = 'GL_IBM_texture_mirrored_repeat' then
    Result := Load_GL_IBM_texture_mirrored_repeat
  else
    if ext = 'GL_IBM_vertex_array_lists' then
    Result := Load_GL_IBM_vertex_array_lists
  else
    if ext = 'GL_MESA_resize_buffers' then
    Result := Load_GL_MESA_resize_buffers
  else
    if ext = 'GL_MESA_window_pos' then
    Result := Load_GL_MESA_window_pos
  else
    if ext = 'GL_OML_interlace' then
    Result := Load_GL_OML_interlace
  else
    if ext = 'GL_OML_resample' then
    Result := Load_GL_OML_resample
  else
    if ext = 'GL_OML_subsample' then
    Result := Load_GL_OML_subsample
  else
    if ext = 'GL_SGIS_generate_mipmap' then
    Result := Load_GL_SGIS_generate_mipmap
  else
    if ext = 'GL_SGIS_multisample' then
    Result := Load_GL_SGIS_multisample
  else
    if ext = 'GL_SGIS_pixel_texture' then
    Result := Load_GL_SGIS_pixel_texture
  else
    if ext = 'GL_SGIS_texture_border_clamp' then
    Result := Load_GL_SGIS_texture_border_clamp
  else
    if ext = 'GL_SGIS_texture_color_mask' then
    Result := Load_GL_SGIS_texture_color_mask
  else
    if ext = 'GL_SGIS_texture_edge_clamp' then
    Result := Load_GL_SGIS_texture_edge_clamp
  else
    if ext = 'GL_SGIS_texture_lod' then
    Result := Load_GL_SGIS_texture_lod
  else
    if ext = 'GL_SGIS_depth_texture' then
    Result := Load_GL_SGIS_depth_texture
  else
    if ext = 'GL_SGIX_fog_offset' then
    Result := Load_GL_SGIX_fog_offset
  else
    if ext = 'GL_SGIX_interlace' then
    Result := Load_GL_SGIX_interlace
  else
    if ext = 'GL_SGIX_shadow_ambient' then
    Result := Load_GL_SGIX_shadow_ambient
  else
    if ext = 'GL_SGI_color_matrix' then
    Result := Load_GL_SGI_color_matrix
  else
    if ext = 'GL_SGI_color_table' then
    Result := Load_GL_SGI_color_table
  else
    if ext = 'GL_SGI_texture_color_table' then
    Result := Load_GL_SGI_texture_color_table
  else
    if ext = 'GL_SUN_vertex' then
    Result := Load_GL_SUN_vertex
  else
    if ext = 'GL_ARB_fragment_program' then
    Result := Load_GL_ARB_fragment_program
  else
    if ext = 'GL_ATI_text_fragment_shader' then
    Result := Load_GL_ATI_text_fragment_shader
  else
    if ext = 'GL_APPLE_client_storage' then
    Result := Load_GL_APPLE_client_storage
  else
    if ext = 'GL_APPLE_element_array' then
    Result := Load_GL_APPLE_element_array
  else
    if ext = 'GL_APPLE_fence' then
    Result := Load_GL_APPLE_fence
  else
    if ext = 'GL_APPLE_vertex_array_object' then
    Result := Load_GL_APPLE_vertex_array_object
  else
    if ext = 'GL_APPLE_vertex_array_range' then
    Result := Load_GL_APPLE_vertex_array_range
  else
    if ext = 'WGL_ARB_pixel_format' then
    Result := Load_WGL_ARB_pixel_format
  else
    if ext = 'WGL_ARB_make_current_read' then
    Result := Load_WGL_ARB_make_current_read
  else
    if ext = 'WGL_ARB_pbuffer' then
    Result := Load_WGL_ARB_pbuffer
  else
    if ext = 'WGL_EXT_swap_control' then
    Result := Load_WGL_EXT_swap_control
  else
    if ext = 'WGL_ARB_render_texture' then
    Result := Load_WGL_ARB_render_texture
  else
    if ext = 'WGL_EXT_extensions_string' then
    Result := Load_WGL_EXT_extensions_string
  else
    if ext = 'WGL_EXT_make_current_read' then
    Result := Load_WGL_EXT_make_current_read
  else
    if ext = 'WGL_EXT_pbuffer' then
    Result := Load_WGL_EXT_pbuffer
  else
    if ext = 'WGL_EXT_pixel_format' then
    Result := Load_WGL_EXT_pixel_format
  else
    if ext = 'WGL_I3D_digital_video_control' then
    Result := Load_WGL_I3D_digital_video_control
  else
    if ext = 'WGL_I3D_gamma' then
    Result := Load_WGL_I3D_gamma
  else
    if ext = 'WGL_I3D_genlock' then
    Result := Load_WGL_I3D_genlock
  else
    if ext = 'GL_ARB_matrix_palette' then
    Result := Load_GL_ARB_matrix_palette
  else
    if ext = 'GL_NV_element_array' then
    Result := Load_GL_NV_element_array
  else
    if ext = 'GL_NV_float_buffer' then
    Result := Load_GL_NV_float_buffer
  else
    if ext = 'GL_NV_fragment_program' then
    Result := Load_GL_NV_fragment_program
  else
    if ext = 'GL_NV_primitive_restart' then
    Result := Load_GL_NV_primitive_restart
  else
    if ext = 'GL_NV_vertex_program2' then
    Result := Load_GL_NV_vertex_program2
  else
    if ext = 'WGL_NV_render_texture_rectangle' then
    Result := Load_WGL_NV_render_texture_rectangle
  else
    if ext = 'GL_NV_pixel_data_range' then
    Result := Load_GL_NV_pixel_data_range
  else
    if ext = 'GL_EXT_texture_rectangle' then
    Result := Load_GL_EXT_texture_rectangle
  else
    if ext = 'GL_S3_s3tc' then
    Result := Load_GL_S3_s3tc
  else
    if ext = 'GL_ATI_draw_buffers' then
    Result := Load_GL_ATI_draw_buffers
  else
    if ext = 'WGL_ATI_pixel_format_float' then
    Result := Load_WGL_ATI_pixel_format_float
  else
    if ext = 'GL_ATI_texture_env_combine3' then
    Result := Load_GL_ATI_texture_env_combine3
  else
    if ext = 'GL_ATI_texture_float' then
    Result := Load_GL_ATI_texture_float
  else
    if ext = 'GL_NV_texture_expand_normal' then
    Result := Load_GL_NV_texture_expand_normal
  else
    if ext = 'GL_NV_half_float' then
    Result := Load_GL_NV_half_float
  else
    if ext = 'GL_ATI_map_object_buffer' then
    Result := Load_GL_ATI_map_object_buffer
  else
    if ext = 'GL_ATI_separate_stencil' then
    Result := Load_GL_ATI_separate_stencil
  else
    if ext = 'GL_ATI_vertex_attrib_array_object' then
    Result := Load_GL_ATI_vertex_attrib_array_object
  else
    if ext = 'GL_ARB_vertex_buffer_object' then
    Result := Load_GL_ARB_vertex_buffer_object
  else
    if ext = 'GL_ARB_occlusion_query' then
    Result := Load_GL_ARB_occlusion_query
  else
    if ext = 'GL_ARB_shader_objects' then
    Result := Load_GL_ARB_shader_objects
  else
    if ext = 'GL_ARB_vertex_shader' then
    Result := Load_GL_ARB_vertex_shader
  else
    if ext = 'GL_ARB_fragment_shader' then
    Result := Load_GL_ARB_fragment_shader
  else
    if ext = 'GL_ARB_shading_language_100' then
    Result := Load_GL_ARB_shading_language_100
  else
    if ext = 'GL_ARB_texture_non_power_of_two' then
    Result := Load_GL_ARB_texture_non_power_of_two
  else
    if ext = 'GL_ARB_point_sprite' then
    Result := Load_GL_ARB_point_sprite
  else
    if ext = 'GL_EXT_depth_bounds_test' then
    Result := Load_GL_EXT_depth_bounds_test
  else
    if ext = 'GL_EXT_secondary_color' then
    Result := Load_GL_EXT_secondary_color
  else
    if ext = 'GL_EXT_texture_mirror_clamp' then
    Result := Load_GL_EXT_texture_mirror_clamp
  else
    if ext = 'GL_EXT_blend_equation_separate' then
    Result := Load_GL_EXT_blend_equation_separate
  else
    if ext = 'GL_MESA_pack_invert' then
    Result := Load_GL_MESA_pack_invert
  else
    if ext = 'GL_MESA_ycbcr_texture' then
    Result := Load_GL_MESA_ycbcr_texture
  else
    if ext = 'GL_ARB_fragment_program_shadow' then
    Result := Load_GL_ARB_fragment_program_shadow
  else
    if ext = 'GL_EXT_fog_coord' then
    Result := Load_GL_EXT_fog_coord
  else
    if ext = 'GL_NV_fragment_program_option' then
    Result := Load_GL_NV_fragment_program_option
  else
    if ext = 'GL_EXT_pixel_buffer_object' then
    Result := Load_GL_EXT_pixel_buffer_object
  else
    if ext = 'GL_NV_fragment_program2' then
    Result := Load_GL_NV_fragment_program2
  else
    if ext = 'GL_NV_vertex_program2_option' then
    Result := Load_GL_NV_vertex_program2_option
  else
    if ext = 'GL_NV_vertex_program3' then
    Result := Load_GL_NV_vertex_program3
  else
    if ext = 'GL_ARB_draw_buffers' then
    Result := Load_GL_ARB_draw_buffers
  else
    if ext = 'GL_ARB_texture_rectangle' then
    Result := Load_GL_ARB_texture_rectangle
  else
    if ext = 'GL_ARB_color_buffer_float' then
    Result := Load_GL_ARB_color_buffer_float
  else
    if ext = 'GL_ARB_half_float_pixel' then
    Result := Load_GL_ARB_half_float_pixel
  else
    if ext = 'GL_ARB_texture_float' then
    Result := Load_GL_ARB_texture_float
  else
    if ext = 'GL_EXT_texture_compression_dxt1' then
    Result := Load_GL_EXT_texture_compression_dxt1
  else
    if ext = 'GL_ARB_pixel_buffer_object' then
    Result := Load_GL_ARB_pixel_buffer_object
  else
    if ext = 'GL_EXT_framebuffer_object' then
    Result := Load_GL_EXT_framebuffer_object
  else
    if ext = 'GL_version_1_4' then
    Result := Load_GL_version_1_4
  else
    if ext = 'GL_version_1_5' then
    Result := Load_GL_version_1_5
  else
    if ext = 'GL_version_2_0' then
