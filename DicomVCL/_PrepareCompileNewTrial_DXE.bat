...
echo "C:\Program Files\Embarcadero\RAD Studio\8.0\bin\Dcc32.exe"  DicomVCLDXE.dpk -N0"C:\Program Files\Embarcadero\RAD Studio\8.0\Dicom"
...
"C:\Program Files\Inno Setup 5\Compil32.exe"  /cc  "C:\dicomvcl\DicomVCL\Setup\DicomEasyD_XE.iss"
rem del E:\D\DicomVCL_DXE.exe 
rem copy c:\Setup\DicomVCL_DXE.exe E:\D\DicomVCL_DXE.exe 
