...
uses
  ...
  KXSecurity, Graphics, cnsmsg, SysUtils, ExtCtrls, forms,
...
type
  ...
  public
    ...
    function FindClient(AID: Integer): TDCMConferenceServerClientThread; overload;
    function FindClient(AUserCode: string): TDCMConferenceServerClientThread; overload;
    function FindClientByUserID(
      AUserID: Integer): TDCMConferenceServerClientThread;

    procedure SendMessageTo(AConferenceID, AConnectionID: Integer; ADataset: TDicomAttributes);
    procedure SendBufferTo(AConferenceID, AConnectionID: Integer; ABuffer: Pointer; AStart, ACount: Integer);

    procedure SendMessageToUserID(AConferenceID, AUserID: Integer; ADataset: TDicomAttributes);
    procedure SendBufferToUserID(AConferenceID, AUserID: Integer; ABuffer: Pointer; AStart, ACount: Integer);
  ...
  public
    ...
    function FindClient(AID: Integer): TDCMConferenceServerClientThread; overload;
    function FindClientByUserID(AUserID: Integer): TDCMConferenceServerClientThread; overload;
    function FindClient(AUserCode: string): TDCMConferenceServerClientThread; overload;
  published
    property ServerPort;
  ...
  protected
    ...
    procedure DoDataTimer(Sender: TObject);
  public
    constructor Create(AOwner: TComponent); override;
    destructor Destroy; override;
    ...
    function PostDataset(Apath: string; AType, AConferenceID: Integer;
...
function TDCMConferenceServerClientThread.FindClient(
  AID: Integer): TDCMConferenceServerClientThread;
begin
...
function TDCMConferenceServerClientThread.FindClient(
  AUserCode: string): TDCMConferenceServerClientThread;
begin
...
procedure TDCMConferenceServerClientThread.SendBufferTo(
...
begin
  ...
  begin
    ...
    begin
      ...
      v1.fFromConnectionID := ConnectionID;
      v1.CopyVideoBuffer(p1, ACount);
      n1.AddMessage(v1);
    end
    else
    begin
...
procedure TDCMConferenceServerClientThread.SendBufferToUserID(
...
begin
  ...
  begin
    ...
    begin
      ...
      v1 := TDcmConferenceMessage.Create;
      v1.Dataset := CopyAttributes(ADataset);
      //      v1.Dataset.AddVariant($2817, $4, 'FRIEND');
      v1.fFromConnectionID := ConnectionID;
      v1.fUserID := UserID;
      v1.fConferenceID := AConferenceID;
      n1.AddMessage(v1);
...
begin
  ...
  begin
    ...
    begin
      ...
      //      v1.Dataset.AddVariant($2817, $4, 'FRIEND');
      v1.fFromConnectionID := ConnectionID;
      v1.fToConnectionID := n1.ConnectionID;
      v1.fUserID := UserID;
      v1.fConferenceID := AConferenceID;
      n1.AddMessage(v1);
    end
    ...
    begin //if the friend offline, tell him
      if assigned(FOnConferenceMessageOffline) then
        FOnConferenceMessageOffline(self, ConnectionID, AUserID, ADataset);
...
procedure TDCMConferenceServerClientThread.SetUserID(const Value: Integer);
begin
  FUserID := Value;
end;

procedure TDCMConferenceServerClientThread.SetUserName(
  const Value: string);
begin
  FUserName := Value;
end;
...
procedure TDCMConferenceServerClientThread.AddMessage(AValue: TDcmConferenceMessage);
var
  l1: TList;
begin
  l1 := fConferenceMessages.LockList;
...
procedure TDCMConferenceServerClientThread.SetUserCode(
  const Value: string);
begin
  FUserCode := Value;
end;
...
procedure TDCMConferenceServerClientThread.SetGroupName(
  const Value: string);
begin
  FGroupName := Value;
end;
    ...
    case pb1^ of
      $10: //command: login, sql,find friend, send message to client...
        begin
          ...
          begin
            cli1.AnswerString('', '', '', 'Unknow Dataset Buffer');
          end;
        end;
      $11: //to all conference
        begin
          if HeaderInfo.PostData.Size > ReserveBufferCount then
          begin
            ...
            try
              ...
              begin
                ...
                v1.Dataset := das1;
                //                v1.Dataset.AddVariant($2817, $4, 'FRIEND');
                v1.fFromConnectionID := Cli1.ConnectionID;
                v1.fUserID := 0; //Cli1.UserID;
                n1.AddMessage(v1);
      ...
      $20, $21, $22, $23: //send video, audio, jpeg, mouse data ....
        begin
          ...
          begin
            ...
            if id1 <> 0 then
              cli1.SendBufferTo(conID1, id1, pb1, 0, HeaderInfo.PostData.Size - ReserveBufferCount)
            else
              break;
          end;
          //          cli1.AnswerString('','','','OK');
      ...
      $30, $31, $32, $33: //send video, audio, jpeg, mouse data ....
        begin
          ...
          begin
            ...
            id1 := pi1^; //connection ID
            if id1 <> 0 then
              cli1.SendBufferToUserID(conID1, id1, pb2, 0, HeaderInfo.PostData.Size - ReserveBufferCount)
            else
              break;
          end;
          //          cli1.AnswerString('','','','OK');
...
begin
  ...
  fDataThread := TTimer.Create(self);
  fDataThread.OnTimer := DoDataTimer;
  fDataThread.Enabled := false;
  //  fDataThread.Execute;
end;
...
begin
  ...
  try
    ...
    das2 := PostDataset('ADD', $10, 0, [0], das1);
    if das2 <> nil then
    begin
...
begin
  ...
  try
    ...
    das2 := PostDataset('LOGIN', $10, 0, [0], das1);
    if das2 <> nil then
    begin
      if (das2.getInteger($2817, $5) <> 1) and (das2.GetString($2817, $6) <> '') then
      begin
...
begin
  ...
  try
    ...
    begin
      ...
      SendStm1.WriteBuffer(@AConferenceID, 4); //$20  or $40
...
function TDCMConferenceClient.PostDataset(Apath: string; AType, AConferenceID: Integer;
  AConnectionIDs: array of Integer; ADataset: TDicomAttributes): TDicomAttributes;
var
  stm1: TMemoryStream;
  SendStm1: TDicomKXSocketStream;
        ...
        begin
          ...
          begin
            case t1 of
              ...
              $20:
                begin
                  TVideoConferenceForm(u1.FDialogForm).DoVideoDataAvailable(self, fReceivedHeaderInfo, p1, l1);
                end;
              $21:
                begin
                  TVideoConferenceForm(u1.FDialogForm).DoAudioDataAvailable(self, fReceivedHeaderInfo, p1, l1);
                end;
              $22:
                begin
                  TVideoConferenceForm(u1.FDialogForm).DoMouseDataAvailable(self, fReceivedHeaderInfo, p1, l1);
                end;
              $23:
                begin
                  // TVideoConferenceForm( u1.FDialogForm).DoAudioDataAvailable(self, fReceivedHeaderInfo, p1, l1);
            ...
            $20:
              begin
                if assigned(FOnVideoDataAvailable) then
                  FOnVideoDataAvailable(self, fReceivedHeaderInfo, p1, l1);
              end;
            $21:
              begin
                if assigned(FOnAudioDataAvailable) then
                  FOnAudioDataAvailable(self, fReceivedHeaderInfo, p1, l1);
              end;
            $22:
              begin
                if assigned(FOnMouseDataAvailable) then
                  FOnMouseDataAvailable(self, fReceivedHeaderInfo, p1, l1);
              end;
            $23:
              begin
                if assigned(FOnAudioDataAvailable) then
...
procedure TDCMConferenceClient.DoDataTimer(Sender: TObject);
begin
  ...
  begin
    ...
    try
      ...
      //fDataThread.Interval := FMaxTimerInterval;
    finally
      if assigned(FOnSocketDisconnect) and (not FSocket.Connected) then
      begin
        FOnSocketDisconnect(self);
      end;
      fDataThread.Enabled := FSocket.Connected;
    end;
  end
  else
    fDataThread.Enabled := false;
...
begin
  try
    PostDataset('MSG', $70, AConferenceID, AUserID, ADataset);
  finally
    ADataset.free;
  end;
end;
...
begin
  try
    ...
    begin
      ...
      begin
        if (not fConferenceClient.AnswerMessage) and
          (not fConferenceClient.QueryServer) then
          ProcessWindowsMessageQueue;
      end;
