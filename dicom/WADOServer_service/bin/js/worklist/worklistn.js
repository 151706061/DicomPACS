...
//	var v_adm=0 
	...
	$("#li_worklist").css("font-weight","bold"); // активный/текущая страница - первый пункт меню

	$("#mygofrmsnimki").css("display","none"); // СНИМКИ убрали из меню
	$("#mygofrmconcl").css("display","none"); //  ПРОТОКОЛЫ убрали из меню
...
function ClrChecked(){
	...
	function AskData(p_s) {
		...
		//
		v_asc  = '<div data-icon="&#xe0f3;"></div>';	
		v_desc = '<div data-icon="&#xe0f2;"></div>';	
