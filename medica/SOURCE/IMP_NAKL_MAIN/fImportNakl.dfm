object fmImportNakl: TfmImportNakl
    ...
    object grTIMP_DOC: TcxGrid
      ...
      object grTIMP_DOCDBBandedTableView1: TcxGridDBBandedTableView
        ...
        object grTIMP_DOCDBBandedTableView1FK_POST_ID: TcxGridDBBandedColumn
          ...
          Properties.ListSource = dsTPostav_List
        ...
        object grTIMP_DOCDBBandedTableView1FL_CHECK_DOGOVOR: TcxGridDBBandedColumn
          ...
          Properties.OnChange = grTIMP_DOCDBBandedTableView1FL_CHECK_DOGOVORPropertiesChange
        ...
        object grTIMP_DOCDBBandedTableView1FD_IMPORT: TcxGridDBBandedColumn
          Caption = #1044#1072#1090#1072' '#1080#1084#1087#1086#1088#1090#1072
          DataBinding.FieldName = 'FD_IMPORT'
          Position.BandIndex = 4
          Position.ColIndex = 0
          Position.RowIndex = 0
        end
        object grTIMP_DOCDBBandedTableView1fk_spec_id: TcxGridDBBandedColumn
          Caption = 'ID '#1089#1087#1077#1094#1080#1092#1080#1082#1072#1094#1080#1080
          DataBinding.FieldName = 'fk_spec_id'
          Visible = False
          Position.BandIndex = 3
          Position.ColIndex = 4
          Position.RowIndex = 0
  ...
  object odsTIMP_DOC: TOracleDataSet
    SQL.Strings = (
      ...
      ''
        ...
        '      a.FC_DOC_DATE_FORMAT, a.FC_PARTY_GODNOST_FORMAT, a.fk_spec' +
        '_id'
      ''
      ''
      '  FROM med.timp_doc a'
    ...
    BeforeEdit = odsTIMP_DOCBeforeEdit
  ...
  object oqMakeImportNaklMedics: TOracleQuery
    SQL.Strings = (
      ...
      '--    pfn_party_num := TO_NUMBER(pfc_party_num) + 1;'
        ...
        '    INSERT INTO MED.TKART (medicid,   fc_serial,   fd_goden,    ' +
        '  fn_price,   fn_kol,   FN_PRODCERTID) '
      
        '                   VALUES (i.medicid, i.FC_SERIAL, i.FD_GODEN_DO' +
        ', i.FN_PRICE, i.FN_KOL, nvl(i.fk_prs_party_sertifikat,i.fk_prs_p' +
        'arty_proizvoditel) ) RETURNING kartid into pFK_KartID;'
  ...
  object oqInitMO: TOracleQuery
    SQL.Strings = (
      ...
      '  SELECT NVL(MAX(MOID),-1) into :nMOID FROM'
        ...
        'n.GET_SOTRID(:pAppSotrID) FROM DUAL) and t.fl_del = 0);'
      ...
      '  :pCUR_MO_SKLAD_ID := med.pkg_medses.GET_CUR_MO_SKLAD_ID;'
      ''
      ''
    ...
    Variables.Data = {
      ...
      3A50535953444154450C00000007000000786F02070101010000000011000000
      3A504355525F4D4F5F534B4C41445F4944030000000400000002000000000000
      00}
    Cursor = crSQLWait
    Left = 12
    Top = 214
  ...
  object oqAddProdCert: TOracleQuery
    SQL.Strings = (
      'begin'
      '  med.pkg_ProdCert.Add( :fc_value, :pID);'
      ''
      'end;')
    Session = os
    Optimize = False
    Variables.Data = {
      0300000002000000090000003A46435F56414C55450500000000000000000000
      00040000003A504944030000000000000000000000}
    Cursor = crSQLWait
    Left = 602
    Top = 182
  end
  object odsTPostav_List: TOracleDataSet
    SQL.Strings = (
      'select p.postavid, p.fc_name from med.tpostav p'
      'order by p.fc_name')
    Optimize = False
    QBEDefinition.QBEFieldDefs = {
      040000001100000005000000464B5F49440100000000000B00000046445F444F
  ...
  object dsTPostav_List: TDataSource
    DataSet = odsTPostav_List
    Left = 774
    Top = 106
  end
end
