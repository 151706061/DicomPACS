object frmPrihEdit: TfrmPrihEdit
  Left = 470
  Top = 319
  Width = 708
  Height = 438
  BorderIcons = [biSystemMenu]
  Caption = #1056#1077#1075#1080#1089#1090#1088#1072#1094#1080#1103' '#1087#1088#1080#1093#1086#1076#1085#1086#1075#1086' '#1076#1086#1082#1091#1084#1077#1085#1090#1072
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object lcbPostav: TDBLookupComboBox
      Left = 120
      Top = 78
      Width = 519
      Height = 21
  ...
  object Panel2: TPanel
    ...
    object cxDBgPrihKart: TcxGrid
      ...
      object cxDBgPrihKartDBTableView1: TcxGridDBTableView
        OnDblClick = cxDBgPrihKartDBTableView1DblClick
        NavigatorButtons.ConfirmDelete = False
        OnEditChanged = cxDBgPrihKartDBTableView1EditChanged
  ...
  object odsPostav: TOracleDataSet
    SQL.Strings = (
      'SELECT POSTAVID, FC_NAME, FC_BOSSDOLG, FC_BOSSFIO'
      '  FROM MED.TPOSTAV'
      '  WHERE FL_DEL = 0'
      '    AND POSTAVID<>MED.PKGTPOSTAV.GET_PRODUCE_POSTAV'
      '  ORDER BY FC_NAME')
    ...
    CommitOnPost = False
    Session = dmMain.os
    AfterScroll = odsPostavAfterScroll
    Left = 390
    Top = 98
  end
  ...
  object odsKart: TOracleDataSet
    ...
    QBEDefinition.QBEFieldDefs = {
      ...
      454E0100000000000C000000464B5F4D4F47524F55504944010000000000}
    Cursor = crSQLWait
    CommitOnPost = False
    Session = dmMain.os
    AfterOpen = odsKartAfterOpen
    AfterRefresh = odsKartAfterOpen
    Left = 56
    Top = 248
    ...
    object odsKartFK_MOGROUPID: TFloatField
      FieldName = 'FK_MOGROUPID'
    end
    object odsKartFD_GODEN: TDateTimeField
      FieldName = 'FD_GODEN'
    end
  end
